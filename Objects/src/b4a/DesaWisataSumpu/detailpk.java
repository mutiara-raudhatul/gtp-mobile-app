...
public class detailpk extends Activity implements B4AActivity{
	public static detailpk mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new anywheresoftware.b4a.ShellBA(this.getApplicationContext(), null, null, "b4a.DesaWisataSumpu", "b4a.DesaWisataSumpu.detailpk");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (detailpk).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.DesaWisataSumpu", "b4a.DesaWisataSumpu.detailpk");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.DesaWisataSumpu.detailpk", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (detailpk) Create " + (isFirst ? "(first time)" : "") + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (detailpk) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (detailpk) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (detailpk) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
RDebugUtils.currentModule="detailpk";
...
RDebugUtils.currentLine=37945347;
 //BA.debugLineNum = 37945347;BA.debugLine="Activity.LoadLayout(\"MainScrollView\")";
mostCurrent._activity.LoadLayout("MainScrollView",mostCurrent.activityBA);
RDebugUtils.currentLine=37945348;
 //BA.debugLineNum = 37945348;BA.debugLine="MainScroll.Panel.LoadLayout(\"Detail\")";
mostCurrent._mainscroll.getPanel().LoadLayout("Detail",mostCurrent.activityBA);
RDebugUtils.currentLine=37945349;
 //BA.debugLineNum = 37945349;BA.debugLine="wvDetail.Height = MainScroll.Height";
mostCurrent._wvdetail.setHeight(mostCurrent._mainscroll.getHeight());
RDebugUtils.currentLine=37945350;
 //BA.debugLineNum = 37945350;BA.debugLine="MainScroll.Panel.Height = MainScroll.Height";
mostCurrent._mainscroll.getPanel().setHeight(mostCurrent._mainscroll.getHeight());
RDebugUtils.currentLine=37945351;
 //BA.debugLineNum = 37945351;BA.debugLine="TitleNavbar.Text = Starter.selectedObj.Get(\"name\"";
...
RDebugUtils.currentLine=37945353;
 //BA.debugLineNum = 37945353;BA.debugLine="MyWebViewExtras.addWebChromeClient(wvDetail, \"wvD";
...
RDebugUtils.currentLine=37945354;
 //BA.debugLineNum = 37945354;BA.debugLine="wvDetail.JavaScriptEnabled = True";
mostCurrent._wvdetail.setJavaScriptEnabled(anywheresoftware.b4a.keywords.Common.True);
RDebugUtils.currentLine=37945355;
 //BA.debugLineNum = 37945355;BA.debugLine="wvDetail.LoadUrl(Main.server&\"api/package/detail/";
mostCurrent._wvdetail.LoadUrl(mostCurrent._main._server /*String*/ +"api/package/detail/"+BA.ObjectToString(mostCurrent._starter._selectedobj /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)("id"))));
...
RDebugUtils.currentLine=38010881;
 //BA.debugLineNum = 38010881;BA.debugLine="Log(\"DetailPK loaded\")";
anywheresoftware.b4a.keywords.Common.LogImpl("038010881","DetailPK loaded",0);
...
RDebugUtils.currentLine=38141952;
 //BA.debugLineNum = 38141952;BA.debugLine="Private Sub BtnBack_Click";
RDebugUtils.currentLine=38141953;
 //BA.debugLineNum = 38141953;BA.debugLine="Log(\"Going back to previous activity\")";
anywheresoftware.b4a.keywords.Common.LogImpl("038141953","Going back to previous activity",0);
RDebugUtils.currentLine=38141954;
 //BA.debugLineNum = 38141954;BA.debugLine="Activity.Finish";
