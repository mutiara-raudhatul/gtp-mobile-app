...
public class detailhm extends Activity implements B4AActivity{
	public static detailhm mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new anywheresoftware.b4a.ShellBA(this.getApplicationContext(), null, null, "b4a.DesaWisataSumpu", "b4a.DesaWisataSumpu.detailhm");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (detailhm).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.DesaWisataSumpu", "b4a.DesaWisataSumpu.detailhm");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.DesaWisataSumpu.detailhm", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (detailhm) Create " + (isFirst ? "(first time)" : "") + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (detailhm) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (detailhm) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (detailhm) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
RDebugUtils.currentModule="detailhm";
if (Debug.shouldDelegate(mostCurrent.activityBA, "activity_create", false))
	 {return ((String) Debug.delegate(mostCurrent.activityBA, "activity_create", new Object[] {_firsttime}));}
RDebugUtils.currentLine=35979264;
 //BA.debugLineNum = 35979264;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
RDebugUtils.currentLine=35979267;
 //BA.debugLineNum = 35979267;BA.debugLine="Activity.LoadLayout(\"MainScrollView\")";
mostCurrent._activity.LoadLayout("MainScrollView",mostCurrent.activityBA);
RDebugUtils.currentLine=35979268;
 //BA.debugLineNum = 35979268;BA.debugLine="MainScroll.Panel.LoadLayout(\"Detail\")";
mostCurrent._mainscroll.getPanel().LoadLayout("Detail",mostCurrent.activityBA);
RDebugUtils.currentLine=35979269;
 //BA.debugLineNum = 35979269;BA.debugLine="wvDetail.Height = MainScroll.Height";
mostCurrent._wvdetail.setHeight(mostCurrent._mainscroll.getHeight());
RDebugUtils.currentLine=35979270;
 //BA.debugLineNum = 35979270;BA.debugLine="MainScroll.Panel.Height = MainScroll.Height";
mostCurrent._mainscroll.getPanel().setHeight(mostCurrent._mainscroll.getHeight());
RDebugUtils.currentLine=35979271;
 //BA.debugLineNum = 35979271;BA.debugLine="TitleNavbar.Text = Starter.selectedObj.Get(\"name\"";
...
RDebugUtils.currentLine=35979273;
 //BA.debugLineNum = 35979273;BA.debugLine="MyWebViewExtras.addWebChromeClient(wvDetail, \"wvD";
...
RDebugUtils.currentLine=35979274;
 //BA.debugLineNum = 35979274;BA.debugLine="wvDetail.JavaScriptEnabled = True";
mostCurrent._wvdetail.setJavaScriptEnabled(anywheresoftware.b4a.keywords.Common.True);
RDebugUtils.currentLine=35979275;
 //BA.debugLineNum = 35979275;BA.debugLine="wvDetail.LoadUrl(Main.server&\"api/homestay/detail";
mostCurrent._wvdetail.LoadUrl(mostCurrent._main._server /*String*/ +"api/homestay/detail/"+BA.ObjectToString(mostCurrent._starter._selectedobj /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)("id"))));
...
RDebugUtils.currentLine=36044801;
 //BA.debugLineNum = 36044801;BA.debugLine="Log(\"DetailHM loaded\")";
anywheresoftware.b4a.keywords.Common.LogImpl("036044801","DetailHM loaded",0);
...
RDebugUtils.currentLine=36175872;
 //BA.debugLineNum = 36175872;BA.debugLine="Private Sub BtnBack_Click";
RDebugUtils.currentLine=36175873;
 //BA.debugLineNum = 36175873;BA.debugLine="Log(\"Going back to previous activity\")";
anywheresoftware.b4a.keywords.Common.LogImpl("036175873","Going back to previous activity",0);
