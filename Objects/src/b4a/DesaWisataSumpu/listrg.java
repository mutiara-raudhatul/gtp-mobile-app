...
public anywheresoftware.b4a.objects.LabelWrapper _addressrg = null;
...
RDebugUtils.currentLine=40304656;
 //BA.debugLineNum = 40304656;BA.debugLine="End Sub";
return "";
}
public static String  _activity_pause(boolean _userclosed) throws Exception{
RDebugUtils.currentModule="listrg";
RDebugUtils.currentLine=40435712;
 //BA.debugLineNum = 40435712;BA.debugLine="Sub Activity_Pause (UserClosed As Boolean)";
RDebugUtils.currentLine=40435713;
 //BA.debugLineNum = 40435713;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=40370176;
 //BA.debugLineNum = 40370176;BA.debugLine="Sub Activity_Resume";
RDebugUtils.currentLine=40370177;
 //BA.debugLineNum = 40370177;BA.debugLine="Log(\"ListRG loaded\")";
anywheresoftware.b4a.keywords.Common.LogImpl("040370177","ListRG loaded",0);
RDebugUtils.currentLine=40370178;
 //BA.debugLineNum = 40370178;BA.debugLine="Dim extra As Map = CreateMap(MediaManager.REQUEST";
...
RDebugUtils.currentLine=40370179;
 //BA.debugLineNum = 40370179;BA.debugLine="DownloadImg(imgMap, isDownloadReady, extra)";
...
RDebugUtils.currentLine=40828928;
 //BA.debugLineNum = 40828928;BA.debugLine="Sub DownloadImg (ImageMap As Map, readyToDownload";
RDebugUtils.currentLine=40828929;
 //BA.debugLineNum = 40828929;BA.debugLine="If readyToDownload Then";
if (_readytodownload) { 
RDebugUtils.currentLine=40828930;
 //BA.debugLineNum = 40828930;BA.debugLine="If extra.Size > 0 Then";
if (_extra.getSize()>0) { 
RDebugUtils.currentLine=40828931;
 //BA.debugLineNum = 40828931;BA.debugLine="For i = 0 To ImageMap.Size - 1";
{
final int step3 = 1;
...
RDebugUtils.currentLine=40828932;
 //BA.debugLineNum = 40828932;BA.debugLine="Log(\"Getting \"&ImageMap.GetValueAt(i)&\"@\"&Imag";
anywheresoftware.b4a.keywords.Common.LogImpl("040828932","Getting "+BA.ObjectToString(_imagemap.GetValueAt(_i))+"@"+BA.ObjectToString(_imagemap.GetKeyAt(_i)),0);
RDebugUtils.currentLine=40828933;
 //BA.debugLineNum = 40828933;BA.debugLine="MediaManager.SetMediaWithExtra(ImageMap.GetKey";
...
RDebugUtils.currentLine=40828937;
 //BA.debugLineNum = 40828937;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=40501248;
 //BA.debugLineNum = 40501248;BA.debugLine="Private Sub BtnBack_Click";
RDebugUtils.currentLine=40501249;
 //BA.debugLineNum = 40501249;BA.debugLine="Log(\"Going back to previous activity\")";
anywheresoftware.b4a.keywords.Common.LogImpl("040501249","Going back to previous activity",0);
RDebugUtils.currentLine=40501250;
 //BA.debugLineNum = 40501250;BA.debugLine="Activity.Finish";
...
RDebugUtils.currentLine=40763392;
 //BA.debugLineNum = 40763392;BA.debugLine="Private Sub btnRefresh_Click";
RDebugUtils.currentLine=40763393;
 //BA.debugLineNum = 40763393;BA.debugLine="Log(\"Refreshing ListRG...\")";
anywheresoftware.b4a.keywords.Common.LogImpl("040763393","Refreshing ListRG...",0);
RDebugUtils.currentLine=40763394;
 //BA.debugLineNum = 40763394;BA.debugLine="btnRefresh.Visible = False";
mostCurrent._btnrefresh.setVisible(anywheresoftware.b4a.keywords.Common.False);
RDebugUtils.currentLine=40763395;
 //BA.debugLineNum = 40763395;BA.debugLine="loadRefresh.Visible = True";
mostCurrent._loadrefresh.setVisible(anywheresoftware.b4a.keywords.Common.True);
RDebugUtils.currentLine=40763396;
 //BA.debugLineNum = 40763396;BA.debugLine="Core.ExecuteUrlGet(Main.API&\"homestay\", \"LoadRG\",";
mostCurrent._core._executeurlget /*String*/ (mostCurrent.activityBA,mostCurrent._main._api /*String*/ +"homestay","LoadRG",listrg.getObject());
RDebugUtils.currentLine=40763397;
 //BA.debugLineNum = 40763397;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=40566784;
 //BA.debugLineNum = 40566784;BA.debugLine="Private Sub CLV_ItemClick (Index As Int, Value As";
...
RDebugUtils.currentLine=40632320;
 //BA.debugLineNum = 40632320;BA.debugLine="Private Sub CreateItem (id As String, name As Stri";
RDebugUtils.currentLine=40632321;
 //BA.debugLineNum = 40632321;BA.debugLine="Dim p As B4XView = xui.CreatePanel(\"\")";
_p = new anywheresoftware.b4a.objects.B4XViewWrapper();
_p = _xui.CreatePanel(processBA,"");
RDebugUtils.currentLine=40632322;
 //BA.debugLineNum = 40632322;BA.debugLine="p.SetLayoutAnimated(0, 0, 0, 100%x, 160dip)";
...
RDebugUtils.currentLine=40697856;
 //BA.debugLineNum = 40697856;BA.debugLine="Sub JobDone (Job As HttpJob)";
RDebugUtils.currentLine=40697857;
 //BA.debugLineNum = 40697857;BA.debugLine="Log(\"JobName = \" & Job.JobName & \", Success = \" &";
anywheresoftware.b4a.keywords.Common.LogImpl("040697857","JobName = "+_job._jobname /*String*/ +", Success = "+BA.ObjectToString(_job._success /*boolean*/ ),0);
RDebugUtils.currentLine=40697858;
 //BA.debugLineNum = 40697858;BA.debugLine="If Job.Success Then";
if (_job._success /*boolean*/ ) { 
RDebugUtils.currentLine=40697859;
 //BA.debugLineNum = 40697859;BA.debugLine="Dim res As String";
_res = "";
RDebugUtils.currentLine=40697860;
 //BA.debugLineNum = 40697860;BA.debugLine="res = Job.GetString";
...
RDebugUtils.currentLine=40697862;
 //BA.debugLineNum = 40697862;BA.debugLine="parser.Initialize(res)";
_parser.Initialize(_res);
RDebugUtils.currentLine=40697865;
 //BA.debugLineNum = 40697865;BA.debugLine="Select Job.JobName";
switch (BA.switchObjectToInt(_job._jobname /*String*/ ,"LoadRG")) {
case 0: {
RDebugUtils.currentLine=40697867;
 //BA.debugLineNum = 40697867;BA.debugLine="Try";
try {RDebugUtils.currentLine=40697868;
 //BA.debugLineNum = 40697868;BA.debugLine="Dim map As Map";
_map = new anywheresoftware.b4a.objects.collections.Map();
RDebugUtils.currentLine=40697869;
 //BA.debugLineNum = 40697869;BA.debugLine="map = parser.NextObject";
_map = _parser.NextObject();
RDebugUtils.currentLine=40697870;
 //BA.debugLineNum = 40697870;BA.debugLine="Dim data As List";
_data = new anywheresoftware.b4a.objects.collections.List();
RDebugUtils.currentLine=40697871;
 //BA.debugLineNum = 40697871;BA.debugLine="data = map.Get(\"data\")";
...
RDebugUtils.currentLine=40697872;
 //BA.debugLineNum = 40697872;BA.debugLine="If data.Size-1 > 0 Then";
if (_data.getSize()-1>0) { 
RDebugUtils.currentLine=40697873;
 //BA.debugLineNum = 40697873;BA.debugLine="CLV.Clear";
mostCurrent._clv._clear();
RDebugUtils.currentLine=40697874;
 //BA.debugLineNum = 40697874;BA.debugLine="imgMap.Clear";
mostCurrent._imgmap.Clear();
RDebugUtils.currentLine=40697875;
 //BA.debugLineNum = 40697875;BA.debugLine="For i = 0 To data.Size-1";
{
final int step17 = 1;
...
RDebugUtils.currentLine=40697876;
 //BA.debugLineNum = 40697876;BA.debugLine="Dim rg As Map";
_rg = new anywheresoftware.b4a.objects.collections.Map();
RDebugUtils.currentLine=40697877;
 //BA.debugLineNum = 40697877;BA.debugLine="rg = data.Get(i)";
...
RDebugUtils.currentLine=40697878;
 //BA.debugLineNum = 40697878;BA.debugLine="CLV.Add(CreateItem(rg.Get(\"id\"), rg.Get(\"na";
...
RDebugUtils.currentLine=40697879;
 //BA.debugLineNum = 40697879;BA.debugLine="CLV.AsView.Height = PanelListItem.Height *";
mostCurrent._clv._asview().setHeight((int) (mostCurrent._panellistitem.getHeight()*mostCurrent._clv._getsize()));
 }
};
RDebugUtils.currentLine=40697881;
 //BA.debugLineNum = 40697881;BA.debugLine="isDownloadReady = True";
_isdownloadready = anywheresoftware.b4a.keywords.Common.True;
RDebugUtils.currentLine=40697882;
 //BA.debugLineNum = 40697882;BA.debugLine="Dim extra As Map = CreateMap(MediaManager.RE";
_extra = new anywheresoftware.b4a.objects.collections.Map();
_extra = anywheresoftware.b4a.keywords.Common.createMap(new Object[] {(Object)(mostCurrent._mediamanager._request_resize_mode /*String*/ ),(Object)("FILL_NO_DISTORTIONS")});
RDebugUtils.currentLine=40697883;
 //BA.debugLineNum = 40697883;BA.debugLine="DownloadImg(imgMap, isDownloadReady, extra)";
_downloadimg(mostCurrent._imgmap,_isdownloadready,_extra);
RDebugUtils.currentLine=40697884;
 //BA.debugLineNum = 40697884;BA.debugLine="CLV.sv.Height = CLV.AsView.Height";
mostCurrent._clv._sv.setHeight(mostCurrent._clv._asview().getHeight());
RDebugUtils.currentLine=40697885;
 //BA.debugLineNum = 40697885;BA.debugLine="PanelList.Height = CLV.AsView.Height";
mostCurrent._panellist.setHeight(mostCurrent._clv._asview().getHeight());
RDebugUtils.currentLine=40697886;
 //BA.debugLineNum = 40697886;BA.debugLine="MainScroll.Panel.Height = CLV.AsView.Height";
mostCurrent._mainscroll.getPanel().setHeight(mostCurrent._clv._asview().getHeight());
 };
RDebugUtils.currentLine=40697888;
 //BA.debugLineNum = 40697888;BA.debugLine="btnRefresh.Visible = True";
mostCurrent._btnrefresh.setVisible(anywheresoftware.b4a.keywords.Common.True);
RDebugUtils.currentLine=40697889;
 //BA.debugLineNum = 40697889;BA.debugLine="loadRefresh.Visible = False";
mostCurrent._loadrefresh.setVisible(anywheresoftware.b4a.keywords.Common.False);
 } 
       catch (Exception e33) {
			processBA.setLastException(e33);RDebugUtils.currentLine=40697891;
 //BA.debugLineNum = 40697891;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("040697891",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
 break; }
}
;
 };
RDebugUtils.currentLine=40697895;
 //BA.debugLineNum = 40697895;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=40894464;
 //BA.debugLineNum = 40894464;BA.debugLine="Private Sub PanelListItem_Click";
RDebugUtils.currentLine=40894465;
 //BA.debugLineNum = 40894465;BA.debugLine="Dim item As Int = CLV.GetItemFromView(Sender)";
...
RDebugUtils.currentLine=40894466;
 //BA.debugLineNum = 40894466;BA.debugLine="Dim p As B4XView";
_p = new anywheresoftware.b4a.objects.B4XViewWrapper();
RDebugUtils.currentLine=40894467;
 //BA.debugLineNum = 40894467;BA.debugLine="p = CLV.GetPanel(item)";
_p = mostCurrent._clv._getpanel(_item);
RDebugUtils.currentLine=40894469;
 //BA.debugLineNum = 40894469;BA.debugLine="Dim a As B4XView";
_a = new anywheresoftware.b4a.objects.B4XViewWrapper();
RDebugUtils.currentLine=40894470;
 //BA.debugLineNum = 40894470;BA.debugLine="a = p.GetView(0)";
_a = _p.GetView((int) (0));
RDebugUtils.currentLine=40894471;
 //BA.debugLineNum = 40894471;BA.debugLine="Starter.selectedObj.Initialize";
...
RDebugUtils.currentLine=40894472;
 //BA.debugLineNum = 40894472;BA.debugLine="Starter.selectedObj.Put(\"id\", a.GetView(0).GetVie";
...
RDebugUtils.currentLine=40894473;
 //BA.debugLineNum = 40894473;BA.debugLine="Starter.selectedObj.Put(\"name\", a.GetView(0).GetV";
...
RDebugUtils.currentLine=40894475;
 //BA.debugLineNum = 40894475;BA.debugLine="Log(\"Redirect to DetailRG Activity\")";
anywheresoftware.b4a.keywords.Common.LogImpl("040894475","Redirect to DetailRG Activity",0);
RDebugUtils.currentLine=40894476;
 //BA.debugLineNum = 40894476;BA.debugLine="StartActivity(DetailRG)";
