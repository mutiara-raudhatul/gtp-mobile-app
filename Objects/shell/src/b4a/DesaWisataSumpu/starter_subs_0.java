...
try {
		Debug.PushSubsStack("CreateBitmap (starter) ","starter",1,starter.processBA,starter.mostCurrent,100);
...
try {
		Debug.PushSubsStack("Download (starter) ","starter",1,starter.processBA,starter.mostCurrent,62);
...
try {
		Debug.PushSubsStack("DrawRoundBitmap (starter) ","starter",1,starter.processBA,starter.mostCurrent,117);
...
try {
		Debug.PushSubsStack("GPS_LocationChanged (starter) ","starter",1,starter.processBA,starter.mostCurrent,123);
...
Debug.ShouldStop(2);
starter.mostCurrent.__c.runVoidMethod ("LogImpl","01114119",RemoteObject.createImmutable("Current Location"),0);
 BA.debugLineNum = 131;BA.debugLine="Log(\"Lat = \" & lat)";
Debug.ShouldStop(4);
starter.mostCurrent.__c.runVoidMethod ("LogImpl","01114120",RemoteObject.concat(RemoteObject.createImmutable("Lat = "),starter._lat),0);
 BA.debugLineNum = 132;BA.debugLine="Log(\"Lng = \" & lng)";
Debug.ShouldStop(8);
starter.mostCurrent.__c.runVoidMethod ("LogImpl","01114121",RemoteObject.concat(RemoteObject.createImmutable("Lng = "),starter._lng),0);
...
if (RemoteObject.solveBoolean("=",starter._mapstatus,BA.ObjectToString("RG"))) { 
 BA.debugLineNum = 135;BA.debugLine="CallSub(MapsHM, \"UpdateLocation\")";
Debug.ShouldStop(64);
starter.mostCurrent.__c.runMethodAndSync(false,"CallSubNew",starter.processBA,(Object)((starter.mostCurrent._mapshm.getObject())),(Object)(RemoteObject.createImmutable("UpdateLocation")));
 }else 
{ BA.debugLineNum = 136;BA.debugLine="Else If mapStatus == \"AT\" Then";
Debug.ShouldStop(128);
if (RemoteObject.solveBoolean("=",starter._mapstatus,BA.ObjectToString("AT"))) { 
 BA.debugLineNum = 137;BA.debugLine="CallSub(MapsAT, \"UpdateLocation\")";
Debug.ShouldStop(256);
...
try {
		Debug.PushSubsStack("JobDone (starter) ","starter",1,starter.processBA,starter.mostCurrent,78);
...
Debug.ShouldStop(1073741824);
starter.mostCurrent.__c.runVoidMethod ("LogImpl","0917521",RemoteObject.concat(RemoteObject.createImmutable("Error downloading image: "),_job.getField(true,"_jobname" /*RemoteObject*/ ),starter.mostCurrent.__c.getField(true,"CRLF"),_job.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 };
...
try {
		Debug.PushSubsStack("StartGPS (starter) ","starter",1,starter.processBA,starter.mostCurrent,46);
...
Debug.ShouldStop(131072);
starter.mostCurrent.__c.runVoidMethod ("LogImpl","0720900",RemoteObject.createImmutable("GPS is started"),0);
 };
...
try {
		Debug.PushSubsStack("StopGPS (starter) ","starter",1,starter.processBA,starter.mostCurrent,54);
...
Debug.ShouldStop(33554432);
starter.mostCurrent.__c.runVoidMethod ("LogImpl","0786436",RemoteObject.createImmutable("GPS is stopped"),0);
 };
