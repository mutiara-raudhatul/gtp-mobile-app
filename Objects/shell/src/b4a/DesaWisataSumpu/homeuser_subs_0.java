...
try {
		Debug.PushSubsStack("Activity_Create (homeuser) ","homeuser",13,homeuser.mostCurrent.activityBA,homeuser.mostCurrent,38);
...
try {
		Debug.PushSubsStack("Activity_Pause (homeuser) ","homeuser",13,homeuser.mostCurrent.activityBA,homeuser.mostCurrent,55);
...
try {
		Debug.PushSubsStack("Activity_Resume (homeuser) ","homeuser",13,homeuser.mostCurrent.activityBA,homeuser.mostCurrent,50);
...
homeuser.mostCurrent.__c.runVoidMethod ("LogImpl","039780353",RemoteObject.createImmutable("HomeUser loaded"),0);
...
try {
		Debug.PushSubsStack("BtnEV_Click (homeuser) ","homeuser",13,homeuser.mostCurrent.activityBA,homeuser.mostCurrent,141);
...
Debug.ShouldStop(4096);
 BA.debugLineNum = 142;BA.debugLine="Log(\"Redirect to MapsAT Activity\")";
Debug.ShouldStop(8192);
homeuser.mostCurrent.__c.runVoidMethod ("LogImpl","040108033",RemoteObject.createImmutable("Redirect to MapsAT Activity"),0);
 BA.debugLineNum = 143;BA.debugLine="StartActivity(MapsAT)";
...
try {
		Debug.PushSubsStack("BtnLogout_Click (homeuser) ","homeuser",13,homeuser.mostCurrent.activityBA,homeuser.mostCurrent,135);
...
homeuser.mostCurrent.__c.runVoidMethod ("LogImpl","040042497",RemoteObject.createImmutable("Redirect to Main Activity"),0);
...
try {
		Debug.PushSubsStack("BtnRG_Click (homeuser) ","homeuser",13,homeuser.mostCurrent.activityBA,homeuser.mostCurrent,130);
...
Debug.ShouldStop(4);
homeuser.mostCurrent.__c.runVoidMethod ("LogImpl","039976961",RemoteObject.createImmutable("Redirect to MapsRG Activity"),0);
 BA.debugLineNum = 132;BA.debugLine="StartActivity(MapsHM)";
Debug.ShouldStop(8);
homeuser.mostCurrent.__c.runVoidMethod ("StartActivity",homeuser.processBA,(Object)((homeuser.mostCurrent._mapshm.getObject())));
...
try {
		Debug.PushSubsStack("JobDone (homeuser) ","homeuser",13,homeuser.mostCurrent.activityBA,homeuser.mostCurrent,59);
...
homeuser.mostCurrent.__c.runVoidMethod ("LogImpl","039911425",RemoteObject.concat(RemoteObject.createImmutable("JobName = "),_job.getField(true,"_jobname" /*RemoteObject*/ ),RemoteObject.createImmutable(", Success = "),_job.getField(true,"_success" /*RemoteObject*/ )),0);
...
Debug.ShouldStop(2);
homeuser.mostCurrent.__c.runVoidMethod ("LogImpl","039911431",RemoteObject.concat(RemoteObject.createImmutable("Response from server :"),_res),0);
...
Debug.ShouldStop(268435456);
homeuser.mostCurrent.__c.runVoidMethod ("LogImpl","039911458",BA.ObjectToString(homeuser.mostCurrent.__c.runMethod(false,"LastException",homeuser.mostCurrent.activityBA)),0);
 };
 break; }
case 1: {
...
Debug.ShouldStop(512);
homeuser.mostCurrent.__c.runVoidMethod ("LogImpl","039911471",RemoteObject.createImmutable("Successfully logged out"),0);
...
Debug.ShouldStop(16384);
homeuser.mostCurrent.__c.runVoidMethod ("LogImpl","039911476",BA.ObjectToString(homeuser.mostCurrent.__c.runMethod(false,"LastException",homeuser.mostCurrent.activityBA)),0);
 };
 break; }
}
;
...
Debug.ShouldStop(16777216);
homeuser.mostCurrent.__c.runVoidMethod ("LogImpl","039911486",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_job.getField(true,"_errormessage" /*RemoteObject*/ )),0);
