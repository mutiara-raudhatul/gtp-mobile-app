...
try {
		Debug.PushSubsStack("AddScheme (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,43);
...
try {
		Debug.PushSubsStack("Complete (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,306);
...
try {
		Debug.PushSubsStack("Delete (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,252);
...
try {
		Debug.PushSubsStack("Delete2 (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,263);
...
try {
		Debug.PushSubsStack("Download (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,210);
...
try {
		Debug.PushSubsStack("Download2 (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,226);
...
try {
		Debug.PushSubsStack("escapeLink (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,237);
...
try {
		Debug.PushSubsStack("GetBitmap (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,321);
...
try {
		Debug.PushSubsStack("GetBitmapResize (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,332);
...
try {
		Debug.PushSubsStack("GetBitmapSample (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,328);
...
try {
		Debug.PushSubsStack("GetInputStream (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,338);
...
try {
		Debug.PushSubsStack("GetRequest (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,301);
...
try {
		Debug.PushSubsStack("GetString (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,282);
...
try {
		Debug.PushSubsStack("GetString2 (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,287);
...
try {
		Debug.PushSubsStack("Head (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,110);
...
try {
		Debug.PushSubsStack("MultipartStartSection (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,170);
...
try {
		Debug.PushSubsStack("PatchBytes (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,88);
...
Debug.JustUpdateDeviceLine();
httpjob.__c.runVoidMethod ("LogImpl","94521996",(RemoteObject.concat(RemoteObject.createImmutable("Invalid link: "),httpjob.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_link))),RemoteObject.createImmutable(""))),0);
...
try {
		Debug.PushSubsStack("PatchString (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,83);
...
try {
		Debug.PushSubsStack("PostBytes (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,54);
...
try {
		Debug.PushSubsStack("PostFile (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,181);
...
Debug.JustUpdateDeviceLine();
httpjob.__c.runVoidMethod ("LogImpl","94784136",RemoteObject.createImmutable("Cannot send files from the assets folder."),0);
...
try {
		Debug.PushSubsStack("PostMultipart (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,124);
...
try {
		Debug.PushSubsStack("PostString (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,49);
...
try {
		Debug.PushSubsStack("PutBytes (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,71);
...
try {
		Debug.PushSubsStack("PutString (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,66);
...
try {
		Debug.PushSubsStack("Release (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,275);
