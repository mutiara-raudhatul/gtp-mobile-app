...
try {
		Debug.PushSubsStack("AddMedia (smmviews) ","smmviews",18,__ref.getField(false, "ba"),__ref,48);
...
//C
this.state = 25;
 BA.debugLineNum = 116;BA.debugLine="ParentResized(Target)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.smmviews.class, "_parentresized" /*RemoteObject*/ ,(Object)(_target));
 BA.debugLineNum = 117;BA.debugLine="sm.CustomView.As(WebView).LoadUrl(MEDIA.Media)";
Debug.JustUpdateDeviceLine();
(RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.WebViewWrapper"), _sm.getField(false,"CustomView" /*RemoteObject*/ ))).runVoidMethod ("LoadUrl",(Object)(BA.ObjectToString(_media.getField(false,"Media" /*RemoteObject*/ ))));
 if (true) break;
;
 BA.debugLineNum = 119;BA.debugLine="If RequestSet.Callback <> Null And RequestSet.Req";
Debug.JustUpdateDeviceLine();
...
//C
this.state = 28;
 BA.debugLineNum = 120;BA.debugLine="Dim params() As Object = Array(RequestSet.Reques";
Debug.JustUpdateDeviceLine();
_params = RemoteObject.createNewArray("Object",new int[] {2},new Object[] {RemoteObject.createImmutable((RemoteObject.solveBoolean("=",_requestset.getField(true,"RequestState" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(false,"_mmanager" /*RemoteObject*/ ).getField(true,"_state_ready" /*RemoteObject*/ ))))),(_media)});Debug.locals.put("params", _params);Debug.locals.put("params", _params);
 BA.debugLineNum = 121;BA.debugLine="If FadeAnimation > 0 Then";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//C
this.state = 31;
 BA.debugLineNum = 122;BA.debugLine="Sleep(FadeAnimation + 10)";
Debug.JustUpdateDeviceLine();
...
this.state = 32;
;
 BA.debugLineNum = 128;BA.debugLine="RequestSet.Callback.As(JavaObject).RunMethodJO(\"";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("CancelRequest (smmviews) ","smmviews",18,__ref.getField(false, "ba"),__ref,41);
...
try {
		Debug.PushSubsStack("CreateSMMView (smmviews) ","smmviews",18,__ref.getField(false, "ba"),__ref,346);
...
Debug.locals.put("Key", _key);
 BA.debugLineNum = 346;BA.debugLine="Private Sub CreateSMMView (CustomView As Object, m";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 347;BA.debugLine="Dim t1 As SMMView";
Debug.JustUpdateDeviceLine();
_t1 = RemoteObject.createNew ("b4a.DesaWisataSumpu.smmviews._smmview");Debug.locals.put("t1", _t1);
 BA.debugLineNum = 348;BA.debugLine="t1.Initialize";
Debug.JustUpdateDeviceLine();
_t1.runVoidMethod ("Initialize");
 BA.debugLineNum = 349;BA.debugLine="t1.CustomView = CustomView";
Debug.JustUpdateDeviceLine();
_t1.setField ("CustomView" /*RemoteObject*/ ,_customview);
 BA.debugLineNum = 350;BA.debugLine="t1.mBase = mBase";
Debug.JustUpdateDeviceLine();
_t1.setField ("mBase" /*RemoteObject*/ ,_mbase);
 BA.debugLineNum = 351;BA.debugLine="t1.ViewType = ViewType";
Debug.JustUpdateDeviceLine();
_t1.setField ("ViewType" /*RemoteObject*/ ,_viewtype);
 BA.debugLineNum = 352;BA.debugLine="t1.Key = Key";
Debug.JustUpdateDeviceLine();
_t1.setField ("Key" /*RemoteObject*/ ,_key);
 BA.debugLineNum = 353;BA.debugLine="Return t1";
Debug.JustUpdateDeviceLine();
if (true) return _t1;
...
try {
		Debug.PushSubsStack("GetView (smmviews) ","smmviews",18,__ref.getField(false, "ba"),__ref,226);
...
Debug.locals.put("ViewType", _viewtype);
Debug.locals.put("Key", _key);
 BA.debugLineNum = 226;BA.debugLine="Private Sub GetView (ViewType As Int, Key As Strin";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 227;BA.debugLine="For Each sview As SMMView In UnusedViews.AsList";
Debug.JustUpdateDeviceLine();
{
...
Debug.locals.put("sview", _sview);
 BA.debugLineNum = 228;BA.debugLine="If sview.ViewType = ViewType Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_sview.getField(true,"ViewType" /*RemoteObject*/ ),BA.numberCast(double.class, _viewtype))) { 
 BA.debugLineNum = 229;BA.debugLine="UnusedViews.Remove(sview)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_unusedviews" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xset.class, "_remove" /*RemoteObject*/ ,(Object)((_sview)));
 BA.debugLineNum = 233;BA.debugLine="Return CreateSMMView(sview.CustomView, sview.mB";
Debug.JustUpdateDeviceLine();
...
case 0: {
 BA.debugLineNum = 243;BA.debugLine="Dim x As B4XImageView = XUIViewsUtils.CreateB4X";
Debug.JustUpdateDeviceLine();
...
_p = __ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(false,"CreatePanel",__ref.getField(false, "ba"),(Object)(RemoteObject.createImmutable("")));Debug.locals.put("p", _p);Debug.locals.put("p", _p);
 BA.debugLineNum = 249;BA.debugLine="CustomView = p";
Debug.JustUpdateDeviceLine();
_customview = (_p.getObject());Debug.locals.put("CustomView", _customview);
 BA.debugLineNum = 250;BA.debugLine="mBase = p";
Debug.JustUpdateDeviceLine();
_mbase = _p;Debug.locals.put("mBase", _mbase);
 break; }
case 2: {
 BA.debugLineNum = 252;BA.debugLine="Panel.LoadLayout(\"SMMGifView\")";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_panel" /*RemoteObject*/ ).runVoidMethodAndSync ("LoadLayout",(Object)(RemoteObject.createImmutable("SMMGifView")),__ref.getField(false, "ba"));
 BA.debugLineNum = 253;BA.debugLine="CustomView = Panel.GetView(0).Tag";
Debug.JustUpdateDeviceLine();
_customview = __ref.getField(false,"_panel" /*RemoteObject*/ ).runMethod(false,"GetView",(Object)(BA.numberCast(int.class, 0))).runMethod(false,"getTag");Debug.locals.put("CustomView", _customview);
 BA.debugLineNum = 254;BA.debugLine="mBase = Panel.GetView(0)";
Debug.JustUpdateDeviceLine();
_mbase = __ref.getField(false,"_panel" /*RemoteObject*/ ).runMethod(false,"GetView",(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("mBase", _mbase);
 BA.debugLineNum = 255;BA.debugLine="mBase.RemoveViewFromParent";
Debug.JustUpdateDeviceLine();
_mbase.runVoidMethod ("RemoveViewFromParent");
 break; }
case 3: {
 BA.debugLineNum = 257;BA.debugLine="Panel.LoadLayout(\"SMMZoomImageView\")";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_panel" /*RemoteObject*/ ).runVoidMethodAndSync ("LoadLayout",(Object)(RemoteObject.createImmutable("SMMZoomImageView")),__ref.getField(false, "ba"));
 BA.debugLineNum = 258;BA.debugLine="CustomView = Panel.GetView(0).Tag";
Debug.JustUpdateDeviceLine();
_customview = __ref.getField(false,"_panel" /*RemoteObject*/ ).runMethod(false,"GetView",(Object)(BA.numberCast(int.class, 0))).runMethod(false,"getTag");Debug.locals.put("CustomView", _customview);
 BA.debugLineNum = 259;BA.debugLine="mBase = Panel.GetView(0)";
Debug.JustUpdateDeviceLine();
_mbase = __ref.getField(false,"_panel" /*RemoteObject*/ ).runMethod(false,"GetView",(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("mBase", _mbase);
 BA.debugLineNum = 260;BA.debugLine="mBase.RemoveViewFromParent";
Debug.JustUpdateDeviceLine();
_mbase.runVoidMethod ("RemoveViewFromParent");
 break; }
case 4: {
 break; }
case 5: {
 BA.debugLineNum = 283;BA.debugLine="Dim p As B4XView = xui.CreatePanel(\"\")";
Debug.JustUpdateDeviceLine();
_p = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
_p = __ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(false,"CreatePanel",__ref.getField(false, "ba"),(Object)(RemoteObject.createImmutable("")));Debug.locals.put("p", _p);Debug.locals.put("p", _p);
 BA.debugLineNum = 284;BA.debugLine="p.SetLayoutAnimated(0, 0, 0, 100dip, 100dip)";
Debug.JustUpdateDeviceLine();
...
_p.runVoidMethod ("AddView",(Object)((_wv.getObject())),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(_p.runMethod(true,"getWidth")),(Object)(_p.runMethod(true,"getHeight")));
 BA.debugLineNum = 288;BA.debugLine="CustomView = wv";
Debug.JustUpdateDeviceLine();
_customview = (_wv.getObject());Debug.locals.put("CustomView", _customview);
 BA.debugLineNum = 289;BA.debugLine="mBase = p";
Debug.JustUpdateDeviceLine();
_mbase = _p;Debug.locals.put("mBase", _mbase);
 break; }
}
;
 BA.debugLineNum = 291;BA.debugLine="Return CreateSMMView(CustomView, mBase, ViewType,";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("Initialize (smmviews) ","smmviews",18,__ref.getField(false, "ba"),__ref,33);
...
try {
		Debug.PushSubsStack("MediaToBitmap (smmviews) ","smmviews",18,__ref.getField(false, "ba"),__ref,134);
if (RapidSub.canDelegate("mediatobitmap")) { return __ref.runUserSub(false, "smmviews","mediatobitmap", __ref, _media);}
RemoteObject _decoder = RemoteObject.declareNull("anywheresoftware.b4j.object.JavaObject");
Debug.locals.put("MEDIA", _media);
 BA.debugLineNum = 134;BA.debugLine="Private Sub MediaToBitmap(MEDIA As SMMedia) As B4X";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 136;BA.debugLine="If mManager.IsWebPAnimated(MEDIA) Then";
Debug.JustUpdateDeviceLine();
if (__ref.getField(false,"_mmanager" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.simplemediamanager.class, "_iswebpanimated" /*RemoteObject*/ ,(Object)(_media)).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 137;BA.debugLine="Dim decoder As JavaObject";
Debug.JustUpdateDeviceLine();
_decoder = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");Debug.locals.put("decoder", _decoder);
 BA.debugLineNum = 138;BA.debugLine="Return decoder.InitializeStatic(\"android.graphic";
Debug.JustUpdateDeviceLine();
if (true) return RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper"), _decoder.runMethod(false,"InitializeStatic",(Object)(RemoteObject.createImmutable("android.graphics.ImageDecoder"))).runMethod(false,"RunMethod",(Object)(BA.ObjectToString("decodeBitmap")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {_media.getField(false,"Media" /*RemoteObject*/ )}))));
 ...
 BA.debugLineNum = 141;BA.debugLine="Return MEDIA.Media";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("MediaTypeToViewType (smmviews) ","smmviews",18,__ref.getField(false, "ba"),__ref,163);
...
Debug.locals.put("Request", _request);
 BA.debugLineNum = 163;BA.debugLine="Private Sub MediaTypeToViewType(MediaType As Int,";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 164;BA.debugLine="Select MediaType";
Debug.JustUpdateDeviceLine();
...
case 0: 
case 1: {
 BA.debugLineNum = 171;BA.debugLine="Return VIEW_TYPE_B4XIMAGEVIEW";
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(true,"_view_type_b4ximageview" /*RemoteObject*/ );
 break; }
case 2: {
 BA.debugLineNum = 173;BA.debugLine="Return VIEW_TYPE_GIFVIEW";
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(true,"_view_type_gifview" /*RemoteObject*/ );
 break; }
case 3: {
 BA.debugLineNum = 175;BA.debugLine="Return VIEW_TYPE_VIDEOPLAYER";
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(true,"_view_type_videoplayer" /*RemoteObject*/ );
 break; }
case 4: {
 BA.debugLineNum = 177;BA.debugLine="Return VIEW_TYPE_NONE";
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(true,"_view_type_none" /*RemoteObject*/ );
 break; }
case 5: {
 BA.debugLineNum = 179;BA.debugLine="Return VIEW_TYPE_WEBVIEW";
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(true,"_view_type_webview" /*RemoteObject*/ );
 break; }
default: {
 BA.debugLineNum = 181;BA.debugLine="Log(\"Unexpected media type: \" & MediaType)";
Debug.JustUpdateDeviceLine();
smmviews.__c.runVoidMethod ("LogImpl","98388626",RemoteObject.concat(RemoteObject.createImmutable("Unexpected media type: "),_mediatype),0);
 BA.debugLineNum = 182;BA.debugLine="Return VIEW_TYPE_NONE";
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(true,"_view_type_none" /*RemoteObject*/ );
 break; }
}
...
try {
		Debug.PushSubsStack("MimeToMediaType (smmviews) ","smmviews",18,__ref.getField(false, "ba"),__ref,144);
...
Debug.locals.put("Mime", _mime);
 BA.debugLineNum = 144;BA.debugLine="Public Sub MimeToMediaType (Mime As String) As Int";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 145;BA.debugLine="If Mime.StartsWith(\"image/gif\") Then";
Debug.JustUpdateDeviceLine();
if (_mime.runMethod(true,"startsWith",(Object)(RemoteObject.createImmutable("image/gif"))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 146;BA.debugLine="If GIF_SUPPORTED = False Then Log(\"*** Add a ref";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_gif_supported" /*RemoteObject*/ ),smmviews.__c.getField(true,"False"))) { 
smmviews.__c.runVoidMethod ("LogImpl","98323074",RemoteObject.createImmutable("*** Add a reference to B4XGIfView and add SMM_GIF to the build configuration ***"),0);};
 BA.debugLineNum = 147;BA.debugLine="Return IIf(GIF_SUPPORTED, MEDIA_TYPE_GIF, MEDIA_";
Debug.JustUpdateDeviceLine();
...
{ BA.debugLineNum = 148;BA.debugLine="Else If Mime.StartsWith(\"image/webp\") Then";
Debug.JustUpdateDeviceLine();
if (_mime.runMethod(true,"startsWith",(Object)(RemoteObject.createImmutable("image/webp"))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 149;BA.debugLine="If WEBP_SUPPORTED = False Then Log(\"*** Add a re";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_webp_supported" /*RemoteObject*/ ),smmviews.__c.getField(true,"False"))) { 
smmviews.__c.runVoidMethod ("LogImpl","98323077",RemoteObject.createImmutable("*** Add a reference to WebP library and add SMM_WEBP to the build configuration ***"),0);};
 BA.debugLineNum = 150;BA.debugLine="Return IIf(WEBP_SUPPORTED, MEDIA_TYPE_WEBP, MEDI";
Debug.JustUpdateDeviceLine();
...
{ BA.debugLineNum = 151;BA.debugLine="Else If Mime.StartsWith(\"image/\") Then";
Debug.JustUpdateDeviceLine();
if (_mime.runMethod(true,"startsWith",(Object)(RemoteObject.createImmutable("image/"))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 152;BA.debugLine="Return MEDIA_TYPE_IMAGE";
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(true,"_media_type_image" /*RemoteObject*/ );
 }else 
{ BA.debugLineNum = 153;BA.debugLine="Else if Mime.StartsWith(\"video/\") Then";
Debug.JustUpdateDeviceLine();
if (_mime.runMethod(true,"startsWith",(Object)(RemoteObject.createImmutable("video/"))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 154;BA.debugLine="If VIDEO_SUPPORTED = False Then Log(\"*** Add a r";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_video_supported" /*RemoteObject*/ ),smmviews.__c.getField(true,"False"))) { 
smmviews.__c.runVoidMethod ("LogImpl","98323082",RemoteObject.createImmutable("*** Add a reference to the video library and add SMM_VIDEO to the build configuration ***"),0);};
 BA.debugLineNum = 155;BA.debugLine="Return IIf(VIDEO_SUPPORTED, MEDIA_TYPE_VIDEO, ME";
Debug.JustUpdateDeviceLine();
...
{ BA.debugLineNum = 156;BA.debugLine="Else If Mime.StartsWith(\"text/\") Then";
Debug.JustUpdateDeviceLine();
if (_mime.runMethod(true,"startsWith",(Object)(RemoteObject.createImmutable("text/"))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 157;BA.debugLine="Return MEDIA_TYPE_HTML";
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(true,"_media_type_html" /*RemoteObject*/ );
 }else {
 BA.debugLineNum = 159;BA.debugLine="Return MEDIA_TYPE_NONE";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("ParentResized (smmviews) ","smmviews",18,__ref.getField(false, "ba"),__ref,312);
if (RapidSub.canDelegate("parentresized")) { return __ref.runUserSub(false, "smmviews","parentresized", __ref, _target);}
RemoteObject _sm = RemoteObject.declareNull("b4a.DesaWisataSumpu.smmviews._smmview");
RemoteObject _x = RemoteObject.declareNull("b4a.DesaWisataSumpu.b4ximageview");
Debug.locals.put("Target", _target);
 BA.debugLineNum = 312;BA.debugLine="Public Sub ParentResized (Target As B4XView)";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 313;BA.debugLine="If TargetToSMMViews.ContainsKey(Target) Then";
Debug.JustUpdateDeviceLine();
if (__ref.getField(false,"_targettosmmviews" /*RemoteObject*/ ).runMethod(true,"ContainsKey",(Object)((_target.getObject()))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 314;BA.debugLine="Dim sm As SMMView = TargetToSMMViews.Get(Target)";
Debug.JustUpdateDeviceLine();
_sm = (__ref.getField(false,"_targettosmmviews" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((_target.getObject()))));Debug.locals.put("sm", _sm);Debug.locals.put("sm", _sm);
 BA.debugLineNum = 315;BA.debugLine="sm.mBase.SetLayoutAnimated(0, 0, 0, Target.Width";
Debug.JustUpdateDeviceLine();
_sm.getField(false,"mBase" /*RemoteObject*/ ).runVoidMethod ("SetLayoutAnimated",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(_target.runMethod(true,"getWidth")),(Object)(_target.runMethod(true,"getHeight")));
 BA.debugLineNum = 316;BA.debugLine="Select sm.ViewType";
Debug.JustUpdateDeviceLine();
...
case 0: {
 BA.debugLineNum = 318;BA.debugLine="Dim x As B4XImageView = sm.CustomView";
Debug.JustUpdateDeviceLine();
_x = (_sm.getField(false,"CustomView" /*RemoteObject*/ ));Debug.locals.put("x", _x);Debug.locals.put("x", _x);
 BA.debugLineNum = 319;BA.debugLine="x.Update";
Debug.JustUpdateDeviceLine();
...
case 1: {
 break; }
case 2: {
 BA.debugLineNum = 335;BA.debugLine="sm.CustomView.As(B4XView).SetLayoutAnimated(0,";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("ReturnViewToCache (smmviews) ","smmviews",18,__ref.getField(false, "ba"),__ref,186);
...
Debug.locals.put("sm", _sm);
 BA.debugLineNum = 186;BA.debugLine="Private Sub ReturnViewToCache (sm As SMMView)";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 190;BA.debugLine="sm.mBase.RemoveViewFromParent";
Debug.JustUpdateDeviceLine();
_sm.getField(false,"mBase" /*RemoteObject*/ ).runVoidMethod ("RemoveViewFromParent");
 BA.debugLineNum = 191;BA.debugLine="Select sm.ViewType";
Debug.JustUpdateDeviceLine();
...
case 0: {
 BA.debugLineNum = 193;BA.debugLine="sm.CustomView.As(B4XImageView).Clear";
Debug.JustUpdateDeviceLine();
((_sm.getField(false,"CustomView" /*RemoteObject*/ ))).runClassMethod (b4a.DesaWisataSumpu.b4ximageview.class, "_clear" /*RemoteObject*/ );
 break; }
case 1: {
 BA.debugLineNum = 195;BA.debugLine="sm.mBase.GetView(0).SetBitmap(Null)";
Debug.JustUpdateDeviceLine();
...
case 2: {
 break; }
case 3: {
 BA.debugLineNum = 215;BA.debugLine="sm.CustomView.As(JavaObject).RunMethod(\"stopLoa";
Debug.JustUpdateDeviceLine();
(RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), _sm.getField(false,"CustomView" /*RemoteObject*/ ))).runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("stopLoading")),(Object)((smmviews.__c.getField(false,"Null"))));
 BA.debugLineNum = 217;BA.debugLine="sm.CustomView.As(WebView).LoadHtml(\"\")";
Debug.JustUpdateDeviceLine();
...
;
 BA.debugLineNum = 223;BA.debugLine="UnusedViews.Add(sm)";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("TypeToString (smmviews) ","smmviews",18,__ref.getField(false, "ba"),__ref,295);
if (RapidSub.canDelegate("typetostring")) { return __ref.runUserSub(false, "smmviews","typetostring", __ref, _viewtype);}
Debug.locals.put("ViewType", _viewtype);
 BA.debugLineNum = 295;BA.debugLine="Private Sub TypeToString (ViewType As Int) As Stri";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 296;BA.debugLine="Select ViewType";
Debug.JustUpdateDeviceLine();
...
case 0: {
 BA.debugLineNum = 298;BA.debugLine="Return \"B4XImageView\"";
Debug.JustUpdateDeviceLine();
if (true) return BA.ObjectToString("B4XImageView");
 break; }
case 1: {
 BA.debugLineNum = 300;BA.debugLine="Return \"B4XGifView\"";
Debug.JustUpdateDeviceLine();
if (true) return BA.ObjectToString("B4XGifView");
 break; }
case 2: {
 BA.debugLineNum = 302;BA.debugLine="Return \"Panel\"";
Debug.JustUpdateDeviceLine();
if (true) return BA.ObjectToString("Panel");
 break; }
case 3: {
 BA.debugLineNum = 304;BA.debugLine="Return \"video player\"";
Debug.JustUpdateDeviceLine();
if (true) return BA.ObjectToString("video player");
 break; }
case 4: {
 BA.debugLineNum = 306;BA.debugLine="Return \"WebView\"";
Debug.JustUpdateDeviceLine();
if (true) return BA.ObjectToString("WebView");
 break; }
case 5: {
 BA.debugLineNum = 308;BA.debugLine="Return \"ZoomImageView\"";
Debug.JustUpdateDeviceLine();
