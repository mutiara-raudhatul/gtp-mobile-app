...
public class mapsat implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("mapsat"), "b4a.DesaWisataSumpu.mapsat");
	}
...
public static RemoteObject _nameat = RemoteObject.createImmutable("");
...
public static RemoteObject _panelat = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _webviewat = RemoteObject.declareNull("anywheresoftware.b4a.objects.WebViewWrapper");
...
public static b4a.DesaWisataSumpu.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",mapsat.mostCurrent._activity,"B4XCollections",Debug.moduleToString(b4a.DesaWisataSumpu.b4xcollections.class),"BtnBack",mapsat.mostCurrent._btnback,"btnList",mapsat.mostCurrent._btnlist,"btnObj",mapsat.mostCurrent._btnobj,"btnUserLoc",mapsat.mostCurrent._btnuserloc,"categoryMap",mapsat._categorymap,"Core",Debug.moduleToString(b4a.DesaWisataSumpu.core.class),"DateUtils",mapsat.mostCurrent._dateutils,"DetailAT",Debug.moduleToString(b4a.DesaWisataSumpu.detailat.class),"DetailHM",Debug.moduleToString(b4a.DesaWisataSumpu.detailhm.class),"DetailPK",Debug.moduleToString(b4a.DesaWisataSumpu.detailpk.class),"DetailRG",Debug.moduleToString(b4a.DesaWisataSumpu.detailrg.class),"Dialog",mapsat.mostCurrent._dialog,"HomeUser",Debug.moduleToString(b4a.DesaWisataSumpu.homeuser.class),"HomeVisitor",Debug.moduleToString(b4a.DesaWisataSumpu.homevisitor.class),"HttpUtils2Service",Debug.moduleToString(b4a.DesaWisataSumpu.httputils2service.class),"isFiltered",mapsat._isfiltered,"ListAT",Debug.moduleToString(b4a.DesaWisataSumpu.listat.class),"ListHM",Debug.moduleToString(b4a.DesaWisataSumpu.listhm.class),"ListPK",Debug.moduleToString(b4a.DesaWisataSumpu.listpk.class),"ListRG",Debug.moduleToString(b4a.DesaWisataSumpu.listrg.class),"Main",Debug.moduleToString(b4a.DesaWisataSumpu.main.class),"MainScroll",mapsat.mostCurrent._mainscroll,"MapsHM",Debug.moduleToString(b4a.DesaWisataSumpu.mapshm.class),"MyWebViewExtras",mapsat.mostCurrent._mywebviewextras,"MyWebViewSettings",mapsat.mostCurrent._mywebviewsettings,"nameAT",mapsat._nameat,"Navbar",mapsat.mostCurrent._navbar,"PanelAT",mapsat.mostCurrent._panelat,"Starter",Debug.moduleToString(b4a.DesaWisataSumpu.starter.class),"WebViewAT",mapsat.mostCurrent._webviewat,"XUI",mapsat._xui,"XUIViewsUtils",Debug.moduleToString(b4a.DesaWisataSumpu.xuiviewsutils.class)};
}
}