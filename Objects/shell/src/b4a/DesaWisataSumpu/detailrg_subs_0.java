...
try {
		Debug.PushSubsStack("Activity_Create (detailrg) ","detailrg",12,detailrg.mostCurrent.activityBA,detailrg.mostCurrent,24);
...
Debug.ShouldStop(4);
detailrg.mostCurrent._wvdetail.runVoidMethod ("LoadUrl",(Object)(RemoteObject.concat(detailrg.mostCurrent._main._server /*RemoteObject*/ ,RemoteObject.createImmutable("api/homestay/detail/"),detailrg.mostCurrent._starter._selectedobj /*RemoteObject*/ .runMethod(false,"Get",(Object)((RemoteObject.createImmutable("id")))))));
...
try {
		Debug.PushSubsStack("Activity_Pause (detailrg) ","detailrg",12,detailrg.mostCurrent.activityBA,detailrg.mostCurrent,42);
...
try {
		Debug.PushSubsStack("Activity_Resume (detailrg) ","detailrg",12,detailrg.mostCurrent.activityBA,detailrg.mostCurrent,38);
...
Debug.ShouldStop(64);
detailrg.mostCurrent.__c.runVoidMethod ("LogImpl","039387137",RemoteObject.createImmutable("DetailRG loaded"),0);
...
try {
		Debug.PushSubsStack("BtnBack_Click (detailrg) ","detailrg",12,detailrg.mostCurrent.activityBA,detailrg.mostCurrent,47);
...
detailrg.mostCurrent.__c.runVoidMethod ("LogImpl","039518209",RemoteObject.createImmutable("Going back to previous activity"),0);
