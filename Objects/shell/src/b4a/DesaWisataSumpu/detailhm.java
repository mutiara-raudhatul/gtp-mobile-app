...
public class detailhm implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("detailhm"), "b4a.DesaWisataSumpu.detailhm");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, detailhm.class);
...
public static b4a.DesaWisataSumpu.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",detailhm.mostCurrent._activity,"B4XCollections",Debug.moduleToString(b4a.DesaWisataSumpu.b4xcollections.class),"BtnBack",detailhm.mostCurrent._btnback,"Core",Debug.moduleToString(b4a.DesaWisataSumpu.core.class),"DateUtils",detailhm.mostCurrent._dateutils,"DetailAT",Debug.moduleToString(b4a.DesaWisataSumpu.detailat.class),"DetailPK",Debug.moduleToString(b4a.DesaWisataSumpu.detailpk.class),"DetailRG",Debug.moduleToString(b4a.DesaWisataSumpu.detailrg.class),"HomeUser",Debug.moduleToString(b4a.DesaWisataSumpu.homeuser.class),"HomeVisitor",Debug.moduleToString(b4a.DesaWisataSumpu.homevisitor.class),"HttpUtils2Service",Debug.moduleToString(b4a.DesaWisataSumpu.httputils2service.class),"ListAT",Debug.moduleToString(b4a.DesaWisataSumpu.listat.class),"ListHM",Debug.moduleToString(b4a.DesaWisataSumpu.listhm.class),"ListPK",Debug.moduleToString(b4a.DesaWisataSumpu.listpk.class),"ListRG",Debug.moduleToString(b4a.DesaWisataSumpu.listrg.class),"Main",Debug.moduleToString(b4a.DesaWisataSumpu.main.class),"MainScroll",detailhm.mostCurrent._mainscroll,"MapsAT",Debug.moduleToString(b4a.DesaWisataSumpu.mapsat.class),"MapsHM",Debug.moduleToString(b4a.DesaWisataSumpu.mapshm.class),"MyWebViewExtras",detailhm.mostCurrent._mywebviewextras,"MyWebViewSettings",detailhm.mostCurrent._mywebviewsettings,"Navbar",detailhm.mostCurrent._navbar,"Starter",Debug.moduleToString(b4a.DesaWisataSumpu.starter.class),"TitleNavbar",detailhm.mostCurrent._titlenavbar,"wvDetail",detailhm.mostCurrent._wvdetail,"XUIViewsUtils",Debug.moduleToString(b4a.DesaWisataSumpu.xuiviewsutils.class)};
}
}