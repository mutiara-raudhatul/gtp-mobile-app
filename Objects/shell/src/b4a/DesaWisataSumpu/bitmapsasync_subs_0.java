...
try {
		Debug.PushSubsStack("Initialize (bitmapsasync) ","bitmapsasync",20,__ref.getField(false, "ba"),__ref,12);
...
try {
		Debug.PushSubsStack("LoadFromFile (bitmapsasync) ","bitmapsasync",20,__ref.getField(false, "ba"),__ref,48);
...
try {
		Debug.PushSubsStack("LoadFromHttpJob (bitmapsasync) ","bitmapsasync",20,__ref.getField(false, "ba"),__ref,20);
