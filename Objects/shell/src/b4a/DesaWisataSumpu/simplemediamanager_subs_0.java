...
try {
		Debug.PushSubsStack("AddLocalMedia (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,71);
...
try {
		Debug.PushSubsStack("CancelDisconnectedTargets (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,469);
...
Debug.locals.put("Media", _media);
 BA.debugLineNum = 469;BA.debugLine="Private Sub CancelDisconnectedTargets (Media As SM";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 470;BA.debugLine="For Each set As B4XSet In Array(Media.UsedBy, Med";
Debug.JustUpdateDeviceLine();
{
...
Debug.locals.put("set", _set);
 BA.debugLineNum = 471;BA.debugLine="For i = set.Size - 1 To 0 Step - 1";
Debug.JustUpdateDeviceLine();
{
final int step2 = -1;
final int limit2 = 0;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 472;BA.debugLine="Dim RequestSet As SMMediaRequestSet = set.AsLis";
Debug.JustUpdateDeviceLine();
_requestset = (_set.runClassMethod (b4a.DesaWisataSumpu.b4xset.class, "_aslist" /*RemoteObject*/ ).runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i))));Debug.locals.put("RequestSet", _requestset);Debug.locals.put("RequestSet", _requestset);
 BA.debugLineNum = 473;BA.debugLine="If RequestSet.NumberOfAncestors > CountAncestor";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_requestset.getField(true,"NumberOfAncestors" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.runClassMethod (b4a.DesaWisataSumpu.simplemediamanager.class, "_countancestors" /*RemoteObject*/ ,(Object)(_requestset.getField(false,"Target" /*RemoteObject*/ )))))) { 
 BA.debugLineNum = 477;BA.debugLine="ViewsManager.CancelRequest(RequestSet.Target)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_viewsmanager" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.smmviews.class, "_cancelrequest" /*RemoteObject*/ ,(Object)(_requestset.getField(false,"Target" /*RemoteObject*/ )));
 BA.debugLineNum = 478;BA.debugLine="set.Remove(RequestSet)";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("CancelRequest (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,395);
...
Debug.locals.put("RequestSet", _requestset);
 BA.debugLineNum = 395;BA.debugLine="Private Sub CancelRequest (RequestSet As SMMediaRe";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 399;BA.debugLine="ViewsRequestSet.Remove(RequestSet.Target)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_viewsrequestset" /*RemoteObject*/ ).runVoidMethod ("Remove",(Object)((_requestset.getField(false,"Target" /*RemoteObject*/ ).getObject())));
 BA.debugLineNum = 400;BA.debugLine="ViewsManager.CancelRequest(RequestSet.Target)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_viewsmanager" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.smmviews.class, "_cancelrequest" /*RemoteObject*/ ,(Object)(_requestset.getField(false,"Target" /*RemoteObject*/ )));
 BA.debugLineNum = 401;BA.debugLine="Dim meta As SMMediaMeta = MetaCache.Get(RequestSe";
Debug.JustUpdateDeviceLine();
_meta = (__ref.getField(false,"_metacache" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((_requestset.getField(false,"MainMedia" /*RemoteObject*/ ).getField(true,"Key" /*RemoteObject*/ )))));Debug.locals.put("meta", _meta);Debug.locals.put("meta", _meta);
 BA.debugLineNum = 402;BA.debugLine="If meta <> Null Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("N",_meta)) { 
 BA.debugLineNum = 403;BA.debugLine="meta.WaitingRequestsSets.Remove(RequestSet)";
Debug.JustUpdateDeviceLine();
_meta.getField(false,"WaitingRequestsSets" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xset.class, "_remove" /*RemoteObject*/ ,(Object)((_requestset)));
 BA.debugLineNum = 404;BA.debugLine="Dim media As SMMedia = MediaCache.Get(RequestSet";
Debug.JustUpdateDeviceLine();
_media = (__ref.getField(false,"_mediacache" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xorderedmap.class, "_get" /*RemoteObject*/ ,(Object)((_requestset.getField(false,"MainMedia" /*RemoteObject*/ ).getField(true,"Key" /*RemoteObject*/ )))));Debug.locals.put("media", _media);Debug.locals.put("media", _media);
 BA.debugLineNum = 405;BA.debugLine="If media <> Null Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("N",_media)) { 
 BA.debugLineNum = 406;BA.debugLine="media.WaitingRequestsSets.Remove(RequestSet)";
Debug.JustUpdateDeviceLine();
_media.getField(false,"WaitingRequestsSets" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xset.class, "_remove" /*RemoteObject*/ ,(Object)((_requestset)));
 BA.debugLineNum = 407;BA.debugLine="media.UsedBy.Remove(RequestSet)";
Debug.JustUpdateDeviceLine();
_media.getField(false,"UsedBy" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xset.class, "_remove" /*RemoteObject*/ ,(Object)((_requestset)));
 BA.debugLineNum = 408;BA.debugLine="CancelDisconnectedTargets(media)";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("ClearMedia (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,388);
...
Debug.locals.put("Target", _target);
 BA.debugLineNum = 388;BA.debugLine="Public Sub ClearMedia(Target As B4XView)";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 389;BA.debugLine="If ViewsRequestSet.ContainsKey(Target) Then";
Debug.JustUpdateDeviceLine();
if (__ref.getField(false,"_viewsrequestset" /*RemoteObject*/ ).runMethod(true,"ContainsKey",(Object)((_target.getObject()))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 390;BA.debugLine="CancelRequest(ViewsRequestSet.Get(Target))";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("CloneRequest (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,526);
...
Debug.locals.put("Request", _request);
 BA.debugLineNum = 526;BA.debugLine="Public Sub CloneRequest(Request As SMMediaRequest)";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 527;BA.debugLine="Dim req As SMMediaRequest = CreateSMMRequest(Requ";
Debug.JustUpdateDeviceLine();
_req = __ref.runClassMethod (b4a.DesaWisataSumpu.simplemediamanager.class, "_createsmmrequest" /*RemoteObject*/ ,(Object)(_request.getField(true,"Key" /*RemoteObject*/ )),(Object)(_request.getField(true,"Url" /*RemoteObject*/ )),(Object)(_request.getField(true,"Mime" /*RemoteObject*/ )));Debug.locals.put("req", _req);Debug.locals.put("req", _req);
 BA.debugLineNum = 528;BA.debugLine="For Each k As String In Request.Extra.Keys";
Debug.JustUpdateDeviceLine();
{
...
Debug.locals.put("k", _k);
 BA.debugLineNum = 529;BA.debugLine="req.Extra.Put(k, Request.Extra.Get(k))";
Debug.JustUpdateDeviceLine();
...
;
 BA.debugLineNum = 531;BA.debugLine="Return req";
Debug.JustUpdateDeviceLine();
if (true) return _req;
...
try {
		Debug.PushSubsStack("CountAncestors (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,572);
...
Debug.locals.put("Target", _target);
 BA.debugLineNum = 572;BA.debugLine="Private Sub CountAncestors(Target As B4XView) As I";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 573;BA.debugLine="Dim p As B4XView = Target";
Debug.JustUpdateDeviceLine();
_p = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
_p = _target;Debug.locals.put("p", _p);Debug.locals.put("p", _p);
 BA.debugLineNum = 574;BA.debugLine="Dim count As Int";
Debug.JustUpdateDeviceLine();
_count = RemoteObject.createImmutable(0);Debug.locals.put("count", _count);
 BA.debugLineNum = 576;BA.debugLine="Do While p.Parent Is View";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("CreateRequest (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,502);
...
Debug.locals.put("Extra", _extra);
 BA.debugLineNum = 502;BA.debugLine="Public Sub CreateRequest (Url As String, Extra As";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 503;BA.debugLine="Return CreateSMMRequest2(Url, Url, MIME_UNKNOWN,";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("CreateSMMedia (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,546);
...
Debug.locals.put("MediaState", _mediastate);
 BA.debugLineNum = 546;BA.debugLine="Public Sub CreateSMMedia (Media As Object, Meta As";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 547;BA.debugLine="Dim t1 As SMMedia";
Debug.JustUpdateDeviceLine();
_t1 = RemoteObject.createNew ("b4a.DesaWisataSumpu.simplemediamanager._smmedia");Debug.locals.put("t1", _t1);
 BA.debugLineNum = 548;BA.debugLine="t1.Initialize";
Debug.JustUpdateDeviceLine();
_t1.runVoidMethod ("Initialize");
 BA.debugLineNum = 549;BA.debugLine="t1.Media = Media";
Debug.JustUpdateDeviceLine();
_t1.setField ("Media" /*RemoteObject*/ ,_media);
 BA.debugLineNum = 550;BA.debugLine="t1.Meta = Meta";
Debug.JustUpdateDeviceLine();
_t1.setField ("Meta" /*RemoteObject*/ ,_meta);
 BA.debugLineNum = 551;BA.debugLine="t1.MediaState = MediaState";
Debug.JustUpdateDeviceLine();
_t1.setField ("MediaState" /*RemoteObject*/ ,_mediastate);
 BA.debugLineNum = 552;BA.debugLine="t1.WaitingRequestsSets.Initialize";
Debug.JustUpdateDeviceLine();
_t1.getField(false,"WaitingRequestsSets" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xset.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
 BA.debugLineNum = 553;BA.debugLine="t1.UsedBy.Initialize";
Debug.JustUpdateDeviceLine();
_t1.getField(false,"UsedBy" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xset.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
 BA.debugLineNum = 554;BA.debugLine="Return t1";
Debug.JustUpdateDeviceLine();
if (true) return _t1;
...
try {
		Debug.PushSubsStack("CreateSMMediaMeta (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,534);
...
Debug.locals.put("Permanent", _permanent);
 BA.debugLineNum = 534;BA.debugLine="Private Sub CreateSMMediaMeta (Mime As String, Key";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 535;BA.debugLine="Dim t1 As SMMediaMeta";
Debug.JustUpdateDeviceLine();
...
Debug.JustUpdateDeviceLine();
_t1.runVoidMethod ("Initialize");
 BA.debugLineNum = 537;BA.debugLine="t1.Mime = Mime";
Debug.JustUpdateDeviceLine();
_t1.setField ("Mime" /*RemoteObject*/ ,_mime);
 BA.debugLineNum = 538;BA.debugLine="t1.MediaType = ViewsManager.MimeToMediaType(Mime)";
Debug.JustUpdateDeviceLine();
_t1.setField ("MediaType" /*RemoteObject*/ ,__ref.getField(false,"_viewsmanager" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.smmviews.class, "_mimetomediatype" /*RemoteObject*/ ,(Object)(_mime)));
 BA.debugLineNum = 539;BA.debugLine="t1.Key = Key";
Debug.JustUpdateDeviceLine();
_t1.setField ("Key" /*RemoteObject*/ ,_key);
 BA.debugLineNum = 540;BA.debugLine="t1.MetaState = MetaState";
Debug.JustUpdateDeviceLine();
_t1.setField ("MetaState" /*RemoteObject*/ ,_metastate);
 BA.debugLineNum = 541;BA.debugLine="t1.Permanent = Permanent";
Debug.JustUpdateDeviceLine();
_t1.setField ("Permanent" /*RemoteObject*/ ,_permanent);
 BA.debugLineNum = 542;BA.debugLine="t1.WaitingRequestsSets.Initialize";
Debug.JustUpdateDeviceLine();
_t1.getField(false,"WaitingRequestsSets" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xset.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
 BA.debugLineNum = 543;BA.debugLine="Return t1";
Debug.JustUpdateDeviceLine();
if (true) return _t1;
...
try {
		Debug.PushSubsStack("CreateSMMediaRequestSet (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,557);
...
Debug.locals.put("Target", _target);
 BA.debugLineNum = 557;BA.debugLine="Public Sub CreateSMMediaRequestSet (Loading As SMM";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 558;BA.debugLine="Dim t1 As SMMediaRequestSet";
Debug.JustUpdateDeviceLine();
_t1 = RemoteObject.createNew ("b4a.DesaWisataSumpu.simplemediamanager._smmediarequestset");Debug.locals.put("t1", _t1);
 BA.debugLineNum = 559;BA.debugLine="t1.Initialize";
Debug.JustUpdateDeviceLine();
_t1.runVoidMethod ("Initialize");
 BA.debugLineNum = 560;BA.debugLine="t1.Loading = Loading";
Debug.JustUpdateDeviceLine();
_t1.setField ("Loading" /*RemoteObject*/ ,_loading);
 BA.debugLineNum = 561;BA.debugLine="t1.MainMedia = MainMedia";
Debug.JustUpdateDeviceLine();
_t1.setField ("MainMedia" /*RemoteObject*/ ,_mainmedia);
 BA.debugLineNum = 562;BA.debugLine="t1.Error = Error";
Debug.JustUpdateDeviceLine();
_t1.setField ("Error" /*RemoteObject*/ ,_error);
 BA.debugLineNum = 563;BA.debugLine="t1.Target = Target";
Debug.JustUpdateDeviceLine();
_t1.setField ("Target" /*RemoteObject*/ ,_target);
 BA.debugLineNum = 564;BA.debugLine="t1.NumberOfAncestors = CountAncestors(t1.Target)";
Debug.JustUpdateDeviceLine();
_t1.setField ("NumberOfAncestors" /*RemoteObject*/ ,__ref.runClassMethod (b4a.DesaWisataSumpu.simplemediamanager.class, "_countancestors" /*RemoteObject*/ ,(Object)(_t1.getField(false,"Target" /*RemoteObject*/ ))));
 BA.debugLineNum = 565;BA.debugLine="t1.Callback = Null";
Debug.JustUpdateDeviceLine();
_t1.setField ("Callback" /*RemoteObject*/ ,simplemediamanager.__c.getField(false,"Null"));
 BA.debugLineNum = 566;BA.debugLine="If t1.NumberOfAncestors = 0 Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_t1.getField(true,"NumberOfAncestors" /*RemoteObject*/ ),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 567;BA.debugLine="Log(\"Target is not in the views tree!\")";
Debug.JustUpdateDeviceLine();
simplemediamanager.__c.runVoidMethod ("LogImpl","97733258",RemoteObject.createImmutable("Target is not in the views tree!"),0);
 };
...
try {
		Debug.PushSubsStack("CreateSMMRequest (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,506);
...
Debug.locals.put("Url", _url);
Debug.locals.put("Mime", _mime);
 BA.debugLineNum = 506;BA.debugLine="Private Sub CreateSMMRequest (Key As String, Url A";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 507;BA.debugLine="Dim t1 As SMMediaRequest";
Debug.JustUpdateDeviceLine();
_t1 = RemoteObject.createNew ("b4a.DesaWisataSumpu.simplemediamanager._smmediarequest");Debug.locals.put("t1", _t1);
 BA.debugLineNum = 508;BA.debugLine="t1.Initialize";
Debug.JustUpdateDeviceLine();
_t1.runVoidMethod ("Initialize");
 BA.debugLineNum = 509;BA.debugLine="t1.Key = Key";
Debug.JustUpdateDeviceLine();
_t1.setField ("Key" /*RemoteObject*/ ,_key);
 BA.debugLineNum = 510;BA.debugLine="t1.Url = Url";
Debug.JustUpdateDeviceLine();
_t1.setField ("Url" /*RemoteObject*/ ,_url);
 BA.debugLineNum = 511;BA.debugLine="t1.Mime = Mime";
Debug.JustUpdateDeviceLine();
_t1.setField ("Mime" /*RemoteObject*/ ,_mime);
 BA.debugLineNum = 512;BA.debugLine="t1.Extra.Initialize";
Debug.JustUpdateDeviceLine();
_t1.getField(false,"Extra" /*RemoteObject*/ ).runVoidMethod ("Initialize");
 BA.debugLineNum = 513;BA.debugLine="Return t1";
Debug.JustUpdateDeviceLine();
if (true) return _t1;
...
try {
		Debug.PushSubsStack("CreateSMMRequest2 (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,516);
...
Debug.locals.put("Mime", _mime);
Debug.locals.put("Extra", _extra);
 BA.debugLineNum = 516;BA.debugLine="Private Sub CreateSMMRequest2 (Key As String, Url";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 517;BA.debugLine="Dim t1 As SMMediaRequest";
Debug.JustUpdateDeviceLine();
_t1 = RemoteObject.createNew ("b4a.DesaWisataSumpu.simplemediamanager._smmediarequest");Debug.locals.put("t1", _t1);
 BA.debugLineNum = 518;BA.debugLine="t1.Initialize";
Debug.JustUpdateDeviceLine();
_t1.runVoidMethod ("Initialize");
 BA.debugLineNum = 519;BA.debugLine="t1.Key = Key";
Debug.JustUpdateDeviceLine();
_t1.setField ("Key" /*RemoteObject*/ ,_key);
 BA.debugLineNum = 520;BA.debugLine="t1.Url = Url";
Debug.JustUpdateDeviceLine();
_t1.setField ("Url" /*RemoteObject*/ ,_url);
 BA.debugLineNum = 521;BA.debugLine="t1.Mime = Mime";
Debug.JustUpdateDeviceLine();
_t1.setField ("Mime" /*RemoteObject*/ ,_mime);
 BA.debugLineNum = 522;BA.debugLine="t1.Extra = Extra";
Debug.JustUpdateDeviceLine();
_t1.setField ("Extra" /*RemoteObject*/ ,_extra);
 BA.debugLineNum = 523;BA.debugLine="Return t1";
Debug.JustUpdateDeviceLine();
if (true) return _t1;
...
try {
		Debug.PushSubsStack("DeleteMedia (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,439);
...
Debug.locals.put("Media", _media);
 BA.debugLineNum = 439;BA.debugLine="Private Sub DeleteMedia (Media As SMMedia)";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 443;BA.debugLine="If Media.MediaState = STATE_READY Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_media.getField(true,"MediaState" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_state_ready" /*RemoteObject*/ )))) { 
 BA.debugLineNum = 444;BA.debugLine="Select Media.Meta.MediaType";
Debug.JustUpdateDeviceLine();
...
case 0: {
 BA.debugLineNum = 447;BA.debugLine="Dim jo As JavaObject = Media.Media 'B4XBitmap";
Debug.JustUpdateDeviceLine();
...
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), _media.getField(false,"Media" /*RemoteObject*/ ));Debug.locals.put("jo", _jo);Debug.locals.put("jo", _jo);
 BA.debugLineNum = 448;BA.debugLine="jo.RunMethod(\"recycle\", Null)";
Debug.JustUpdateDeviceLine();
_jo.runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("recycle")),(Object)((simplemediamanager.__c.getField(false,"Null"))));
 break; }
case 1: {
 BA.debugLineNum = 451;BA.debugLine="MetaCache.Remove(Media.Meta.Key)";
Debug.JustUpdateDeviceLine();
...
{ BA.debugLineNum = 453;BA.debugLine="Else if Media.MediaState = STATE_LOADING Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_media.getField(true,"MediaState" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_state_loading" /*RemoteObject*/ )))) { 
 BA.debugLineNum = 457;BA.debugLine="If Media.Job.IsInitialized Then";
Debug.JustUpdateDeviceLine();
if (_media.getField(false,"Job" /*RemoteObject*/ ).runMethod(true,"IsInitialized" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 458;BA.debugLine="HttpRequestsManager.CancelRequest(Media.Meta.Fi";
Debug.JustUpdateDeviceLine();
...
;
 BA.debugLineNum = 461;BA.debugLine="MediaCache.Remove(Media.Meta.Key)";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("DesignerSetMedia (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,80);
...
try {
		Debug.PushSubsStack("DownloadImageMedia (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,252);
...
public ResumableSub_DownloadImageMedia(b4a.DesaWisataSumpu.simplemediamanager parent,RemoteObject __ref,RemoteObject _media) {
this.parent = parent;
this.__ref = __ref;
this._media = _media;
}
...
Debug.locals.put("Media", _media);
 BA.debugLineNum = 254;BA.debugLine="If Media.Meta.MetaState = STATE_READY Then";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 255;BA.debugLine="If SleepDurationBeforeDownload > 0 Then";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//C
this.state = 7;
 BA.debugLineNum = 256;BA.debugLine="Sleep(SleepDurationBeforeDownload)";
Debug.JustUpdateDeviceLine();
...
this.state = 7;
;
 BA.debugLineNum = 257;BA.debugLine="CancelDisconnectedTargets(Media)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.simplemediamanager.class, "_canceldisconnectedtargets" /*RemoteObject*/ ,(Object)(_media));
 BA.debugLineNum = 258;BA.debugLine="If IsMediaStillRelevant(Media) = False Then";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//C
this.state = 10;
 BA.debugLineNum = 262;BA.debugLine="DeleteMedia(Media) 'media is loading state. Re";
Debug.JustUpdateDeviceLine();
...
;
 if (true) break;
;
 BA.debugLineNum = 266;BA.debugLine="If Media.Meta.Dir = \"\" Then";
Debug.JustUpdateDeviceLine();
...
//C
this.state = 14;
 BA.debugLineNum = 267;BA.debugLine="Dim job As HttpJob";
Debug.JustUpdateDeviceLine();
_job = RemoteObject.createNew ("b4a.DesaWisataSumpu.httpjob");Debug.locals.put("job", _job);
 BA.debugLineNum = 268;BA.debugLine="job.Initialize(\"\", Me)";
Debug.JustUpdateDeviceLine();
_job.runClassMethod (b4a.DesaWisataSumpu.httpjob.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(BA.ObjectToString("")),(Object)(__ref));
 BA.debugLineNum = 269;BA.debugLine="job.Download(Media.Meta.FirstUrl)";
Debug.JustUpdateDeviceLine();
_job.runClassMethod (b4a.DesaWisataSumpu.httpjob.class, "_download" /*RemoteObject*/ ,(Object)(_media.getField(false,"Meta" /*RemoteObject*/ ).getField(true,"FirstUrl" /*RemoteObject*/ )));
 BA.debugLineNum = 270;BA.debugLine="job.GetRequest.Timeout = DefaultRequestTimeout";
Debug.JustUpdateDeviceLine();
_job.runClassMethod (b4a.DesaWisataSumpu.httpjob.class, "_getrequest" /*RemoteObject*/ ).runMethod(true,"setTimeout",__ref.getField(true,"_defaultrequesttimeout" /*RemoteObject*/ ));
 BA.debugLineNum = 274;BA.debugLine="Media.Job = job";
Debug.JustUpdateDeviceLine();
_media.setField ("Job" /*RemoteObject*/ ,_job);
 BA.debugLineNum = 275;BA.debugLine="Wait For (job) JobDone (job As HttpJob)";
Debug.JustUpdateDeviceLine();
...
;
 BA.debugLineNum = 276;BA.debugLine="Media.Job = JobEmpty";
Debug.JustUpdateDeviceLine();
_media.setField ("Job" /*RemoteObject*/ ,__ref.getField(false,"_jobempty" /*RemoteObject*/ ));
 BA.debugLineNum = 281;BA.debugLine="If job.Success Then";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//C
this.state = 19;
 BA.debugLineNum = 282;BA.debugLine="Wait For (PrepareMedia(Media, job, \"\", \"\", Fal";
Debug.JustUpdateDeviceLine();
...
;
 BA.debugLineNum = 283;BA.debugLine="Media.MediaState = IIf(Media.Media <> Null, ST";
Debug.JustUpdateDeviceLine();
...
//C
this.state = 19;
 BA.debugLineNum = 285;BA.debugLine="Media.MediaState = STATE_ERROR";
Debug.JustUpdateDeviceLine();
...
//C
this.state = 22;
 BA.debugLineNum = 292;BA.debugLine="Wait For (PrepareMedia(Media, Null, Media.Meta.";
Debug.JustUpdateDeviceLine();
...
_unused = (RemoteObject) result.getArrayElement(true,RemoteObject.createImmutable(1));Debug.locals.put("Unused", _unused);
;
 BA.debugLineNum = 293;BA.debugLine="Media.MediaState = IIf(Media.Media <> Null, STA";
Debug.JustUpdateDeviceLine();
_media.setField ("MediaState" /*RemoteObject*/ ,BA.numberCast(int.class, ((RemoteObject.solveBoolean("N",_media.getField(false,"Media" /*RemoteObject*/ ))) ? ((__ref.getField(true,"_state_ready" /*RemoteObject*/ ))) : ((__ref.getField(true,"_state_error" /*RemoteObject*/ ))))));
 if (true) break;
...
//C
this.state = 25;
 BA.debugLineNum = 297;BA.debugLine="Media.MediaState = STATE_ERROR";
Debug.JustUpdateDeviceLine();
_media.setField ("MediaState" /*RemoteObject*/ ,__ref.getField(true,"_state_error" /*RemoteObject*/ ));
 if (true) break;
...
this.state = -1;
;
 BA.debugLineNum = 299;BA.debugLine="MediaIsReady(Media)";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("getMediaCacheSize (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,486);
if (RapidSub.canDelegate("getmediacachesize")) { return __ref.runUserSub(false, "simplemediamanager","getmediacachesize", __ref);}
 BA.debugLineNum = 486;BA.debugLine="Public Sub getMediaCacheSize As Int";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 487;BA.debugLine="Return MediaCache.Size";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("GetRequestFromRequestSet (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,492);
...
Debug.locals.put("rs", _rs);
 BA.debugLineNum = 492;BA.debugLine="Private Sub GetRequestFromRequestSet(rs As SMMedia";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 493;BA.debugLine="If rs.RequestState = STATE_LOADING Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_rs.getField(true,"RequestState" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_state_loading" /*RemoteObject*/ )))) { 
 BA.debugLineNum = 494;BA.debugLine="Return rs.Loading";
Debug.JustUpdateDeviceLine();
if (true) return _rs.getField(false,"Loading" /*RemoteObject*/ );
 }else 
{ BA.debugLineNum = 495;BA.debugLine="Else If rs.RequestState = STATE_ERROR Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_rs.getField(true,"RequestState" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_state_error" /*RemoteObject*/ )))) { 
 BA.debugLineNum = 496;BA.debugLine="Return rs.Error";
Debug.JustUpdateDeviceLine();
if (true) return _rs.getField(false,"Error" /*RemoteObject*/ );
 }else {
 BA.debugLineNum = 498;BA.debugLine="Return rs.MainMedia";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("Initialize (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,41);
...
try {
		Debug.PushSubsStack("IsMediaStillRelevant (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,465);
...
Debug.locals.put("Media", _media);
 BA.debugLineNum = 465;BA.debugLine="Private Sub IsMediaStillRelevant (Media As SMMedia";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 466;BA.debugLine="Return Media.Meta.Permanent Or (Media.MediaState";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("IsWebPAnimated (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,349);
if (RapidSub.canDelegate("iswebpanimated")) { return __ref.runUserSub(false, "simplemediamanager","iswebpanimated", __ref, _media);}
Debug.locals.put("Media", _media);
 BA.debugLineNum = 349;BA.debugLine="Public Sub IsWebPAnimated(Media As SMMedia) As Boo";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 351;BA.debugLine="Return B4ASdkVersion >= 28 And Media.Meta.MediaTy";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("MediaIsReady (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,357);
...
Debug.locals.put("Media", _media);
 BA.debugLineNum = 357;BA.debugLine="Private Sub MediaIsReady (Media As SMMedia)";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 358;BA.debugLine="CancelDisconnectedTargets(Media)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.simplemediamanager.class, "_canceldisconnectedtargets" /*RemoteObject*/ ,(Object)(_media));
 BA.debugLineNum = 359;BA.debugLine="For Each req As SMMediaRequestSet In Media.Waitin";
Debug.JustUpdateDeviceLine();
{
...
Debug.locals.put("req", _req);
 BA.debugLineNum = 360;BA.debugLine="req.RequestState = Media.MediaState";
Debug.JustUpdateDeviceLine();
_req.setField ("RequestState" /*RemoteObject*/ ,_media.getField(true,"MediaState" /*RemoteObject*/ ));
 BA.debugLineNum = 361;BA.debugLine="If Media.MediaState = STATE_READY Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_media.getField(true,"MediaState" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_state_ready" /*RemoteObject*/ )))) { 
 BA.debugLineNum = 362;BA.debugLine="Media.UsedBy.Add(req)";
Debug.JustUpdateDeviceLine();
_media.getField(false,"UsedBy" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xset.class, "_add" /*RemoteObject*/ ,(Object)((_req)));
 BA.debugLineNum = 363;BA.debugLine="ViewsManager.AddMedia(req, Media, GetRequestFro";
Debug.JustUpdateDeviceLine();
...
{ BA.debugLineNum = 364;BA.debugLine="Else if Media.MediaState = STATE_ERROR Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_media.getField(true,"MediaState" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_state_error" /*RemoteObject*/ )))) { 
 BA.debugLineNum = 365;BA.debugLine="ViewsManager.AddMedia(req, MediaCache.Get(req.E";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_viewsmanager" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.smmviews.class, "_addmedia" /*void*/ ,(Object)(_req),(Object)((__ref.getField(false,"_mediacache" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xorderedmap.class, "_get" /*RemoteObject*/ ,(Object)((_req.getField(false,"Error" /*RemoteObject*/ ).getField(true,"Key" /*RemoteObject*/ )))))),(Object)(__ref.runClassMethod (b4a.DesaWisataSumpu.simplemediamanager.class, "_getrequestfromrequestset" /*RemoteObject*/ ,(Object)(_req))));
 ...
 BA.debugLineNum = 367;BA.debugLine="Log(\"MediaIsReady Unexpected state!\")";
Debug.JustUpdateDeviceLine();
simplemediamanager.__c.runVoidMethod ("LogImpl","96619146",RemoteObject.createImmutable("MediaIsReady Unexpected state!"),0);
 }}
;
 }
}Debug.locals.put("req", _req);
;
 BA.debugLineNum = 370;BA.debugLine="Media.WaitingRequestsSets.Clear";
Debug.JustUpdateDeviceLine();
_media.getField(false,"WaitingRequestsSets" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xset.class, "_clear" /*RemoteObject*/ );
 BA.debugLineNum = 371;BA.debugLine="If Media.MediaState = STATE_ERROR Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_media.getField(true,"MediaState" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_state_error" /*RemoteObject*/ )))) { 
 BA.debugLineNum = 375;BA.debugLine="MediaCache.Remove(Media.Meta.Key)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mediacache" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xorderedmap.class, "_remove" /*RemoteObject*/ ,(Object)((_media.getField(false,"Meta" /*RemoteObject*/ ).getField(true,"Key" /*RemoteObject*/ ))));
 };
...
try {
		Debug.PushSubsStack("MetaIsReady (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,205);
...
Debug.locals.put("Meta", _meta);
 BA.debugLineNum = 205;BA.debugLine="Private Sub MetaIsReady (Meta As SMMediaMeta)";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 206;BA.debugLine="For Each RequestSet As SMMediaRequestSet In Meta.";
Debug.JustUpdateDeviceLine();
{
...
Debug.locals.put("RequestSet", _requestset);
 BA.debugLineNum = 210;BA.debugLine="If MediaCache.ContainsKey(Meta.Key) Then";
Debug.JustUpdateDeviceLine();
if (__ref.getField(false,"_mediacache" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xorderedmap.class, "_containskey" /*RemoteObject*/ ,(Object)((_meta.getField(true,"Key" /*RemoteObject*/ )))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 211;BA.debugLine="Dim Media As SMMedia = MediaCache.Get(Meta.Key)";
Debug.JustUpdateDeviceLine();
_media = (__ref.getField(false,"_mediacache" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xorderedmap.class, "_get" /*RemoteObject*/ ,(Object)((_meta.getField(true,"Key" /*RemoteObject*/ )))));Debug.locals.put("Media", _media);Debug.locals.put("Media", _media);
 BA.debugLineNum = 213;BA.debugLine="MediaCache.Remove(Meta.Key)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mediacache" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xorderedmap.class, "_remove" /*RemoteObject*/ ,(Object)((_meta.getField(true,"Key" /*RemoteObject*/ ))));
 BA.debugLineNum = 214;BA.debugLine="MediaCache.Put(Meta.Key, Media)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mediacache" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xorderedmap.class, "_put" /*RemoteObject*/ ,(Object)((_meta.getField(true,"Key" /*RemoteObject*/ ))),(Object)((_media)));
 BA.debugLineNum = 215;BA.debugLine="Media.WaitingRequestsSets.Add(RequestSet)";
Debug.JustUpdateDeviceLine();
_media.getField(false,"WaitingRequestsSets" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xset.class, "_add" /*RemoteObject*/ ,(Object)((_requestset)));
 BA.debugLineNum = 216;BA.debugLine="If Media.MediaState <> STATE_LOADING Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("!",_media.getField(true,"MediaState" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_state_loading" /*RemoteObject*/ )))) { 
 BA.debugLineNum = 217;BA.debugLine="MediaIsReady(Media)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.simplemediamanager.class, "_mediaisready" /*RemoteObject*/ ,(Object)(_media));
 };
 }else {
 BA.debugLineNum = 220;BA.debugLine="Media = CreateSMMedia(Null, Meta, IIf(Meta.Meta";
Debug.JustUpdateDeviceLine();
_media = __ref.runClassMethod (b4a.DesaWisataSumpu.simplemediamanager.class, "_createsmmedia" /*RemoteObject*/ ,(Object)(simplemediamanager.__c.getField(false,"Null")),(Object)(_meta),(Object)(BA.numberCast(int.class, ((RemoteObject.solveBoolean("=",_meta.getField(true,"MetaState" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_state_ready" /*RemoteObject*/ )))) ? ((__ref.getField(true,"_state_loading" /*RemoteObject*/ ))) : ((__ref.getField(true,"_state_error" /*RemoteObject*/ )))))));Debug.locals.put("Media", _media);
 BA.debugLineNum = 221;BA.debugLine="Media.WaitingRequestsSets.Add(RequestSet)";
Debug.JustUpdateDeviceLine();
_media.getField(false,"WaitingRequestsSets" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xset.class, "_add" /*RemoteObject*/ ,(Object)((_requestset)));
 BA.debugLineNum = 222;BA.debugLine="MediaCache.Put(Media.Meta.Key, Media)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mediacache" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xorderedmap.class, "_put" /*RemoteObject*/ ,(Object)((_media.getField(false,"Meta" /*RemoteObject*/ ).getField(true,"Key" /*RemoteObject*/ ))),(Object)((_media)));
 BA.debugLineNum = 223;BA.debugLine="TrimMediaCacheImpl";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.simplemediamanager.class, "_trimmediacacheimpl" /*RemoteObject*/ );
 BA.debugLineNum = 224;BA.debugLine="If Media.MediaState = STATE_ERROR Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_media.getField(true,"MediaState" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_state_error" /*RemoteObject*/ )))) { 
 BA.debugLineNum = 225;BA.debugLine="MediaIsReady(Media)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.simplemediamanager.class, "_mediaisready" /*RemoteObject*/ ,(Object)(_media));
 }else {
 BA.debugLineNum = 227;BA.debugLine="Dim MediaType As Int = Media.Meta.MediaType";
Debug.JustUpdateDeviceLine();
_mediatype = _media.getField(false,"Meta" /*RemoteObject*/ ).getField(true,"MediaType" /*RemoteObject*/ );Debug.locals.put("MediaType", _mediatype);Debug.locals.put("MediaType", _mediatype);
 BA.debugLineNum = 228;BA.debugLine="Select MediaType";
Debug.JustUpdateDeviceLine();
...
case 1: 
case 2: {
 BA.debugLineNum = 230;BA.debugLine="DownloadImageMedia(Media)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.simplemediamanager.class, "_downloadimagemedia" /*void*/ ,(Object)(_media));
 break; }
case 3: 
case 4: {
 BA.debugLineNum = 232;BA.debugLine="Media.MediaState = STATE_READY";
Debug.JustUpdateDeviceLine();
_media.setField ("MediaState" /*RemoteObject*/ ,__ref.getField(true,"_state_ready" /*RemoteObject*/ ));
 BA.debugLineNum = 233;BA.debugLine="Media.Media = Meta.FirstUrl";
Debug.JustUpdateDeviceLine();
_media.setField ("Media" /*RemoteObject*/ ,(_meta.getField(true,"FirstUrl" /*RemoteObject*/ )));
 BA.debugLineNum = 234;BA.debugLine="MediaIsReady(Media)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.simplemediamanager.class, "_mediaisready" /*RemoteObject*/ ,(Object)(_media));
 break; }
case 5: {
 BA.debugLineNum = 236;BA.debugLine="Log(\"Unexpected mime: \" & Media.Meta.Mime)";
Debug.JustUpdateDeviceLine();
simplemediamanager.__c.runVoidMethod ("LogImpl","96357023",RemoteObject.concat(RemoteObject.createImmutable("Unexpected mime: "),_media.getField(false,"Meta" /*RemoteObject*/ ).getField(true,"Mime" /*RemoteObject*/ )),0);
 BA.debugLineNum = 237;BA.debugLine="Media.MediaState = STATE_ERROR";
Debug.JustUpdateDeviceLine();
_media.setField ("MediaState" /*RemoteObject*/ ,__ref.getField(true,"_state_error" /*RemoteObject*/ ));
 BA.debugLineNum = 238;BA.debugLine="MediaIsReady(Media)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.simplemediamanager.class, "_mediaisready" /*RemoteObject*/ ,(Object)(_media));
 break; }
}
...
;
 BA.debugLineNum = 243;BA.debugLine="Meta.WaitingRequestsSets.Clear";
Debug.JustUpdateDeviceLine();
_meta.getField(false,"WaitingRequestsSets" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xset.class, "_clear" /*RemoteObject*/ );
 BA.debugLineNum = 244;BA.debugLine="If Meta.MetaState = STATE_ERROR Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_meta.getField(true,"MetaState" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_state_error" /*RemoteObject*/ )))) { 
 BA.debugLineNum = 248;BA.debugLine="MetaCache.Remove(Meta)";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("PanelResized (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,380);
...
Debug.locals.put("Target", _target);
 BA.debugLineNum = 380;BA.debugLine="Public Sub PanelResized (Target As B4XView)";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 381;BA.debugLine="Dim set As SMMediaRequestSet = ViewsRequestSet.Ge";
Debug.JustUpdateDeviceLine();
_set = (__ref.getField(false,"_viewsrequestset" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((_target.getObject()))));Debug.locals.put("set", _set);Debug.locals.put("set", _set);
 BA.debugLineNum = 382;BA.debugLine="If set <> Null Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("N",_set)) { 
 BA.debugLineNum = 383;BA.debugLine="ViewsManager.ParentResized(Target)";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("PrepareMedia (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,302);
...
Debug.locals.put("FromFile", _fromfile);
 BA.debugLineNum = 303;BA.debugLine="Dim MediaType As Int = Media.Meta.MediaType";
Debug.JustUpdateDeviceLine();
_mediatype = _media.getField(false,"Meta" /*RemoteObject*/ ).getField(true,"MediaType" /*RemoteObject*/ );Debug.locals.put("MediaType", _mediatype);Debug.locals.put("MediaType", _mediatype);
 BA.debugLineNum = 304;BA.debugLine="If MediaType = ViewsManager.MEDIA_TYPE_IMAGE Then";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 305;BA.debugLine="Dim SkipRegularImageLoading As Boolean 'ignore";
Debug.JustUpdateDeviceLine();
_skipregularimageloading = RemoteObject.createImmutable(false);Debug.locals.put("SkipRegularImageLoading", _skipregularimageloading);
 BA.debugLineNum = 312;BA.debugLine="If SkipRegularImageLoading = False Then";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//C
this.state = 7;
 BA.debugLineNum = 313;BA.debugLine="If FromFile Then";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//C
this.state = 12;
 BA.debugLineNum = 314;BA.debugLine="Wait For (ImagesLoader.LoadFromFile(Dir, FileN";
Debug.JustUpdateDeviceLine();
...
//C
this.state = 12;
 BA.debugLineNum = 316;BA.debugLine="Wait For (ImagesLoader.LoadFromHttpJob(job, Ma";
Debug.JustUpdateDeviceLine();
...
this.state = 13;
;
 BA.debugLineNum = 318;BA.debugLine="Media.Media = IIf(bmp.IsInitialized, bmp, Null)";
Debug.JustUpdateDeviceLine();
_media.setField ("Media" /*RemoteObject*/ ,((_bmp.runMethod(true,"IsInitialized").<Boolean>get().booleanValue()) ? ((_bmp.getObject())) : (parent.__c.getField(false,"Null"))));
 if (true) break;
;
 BA.debugLineNum = 320;BA.debugLine="If (xui.IsB4A Or xui.IsB4J) And Media.Meta.Mime";
Debug.JustUpdateDeviceLine();
...
//C
this.state = 16;
 BA.debugLineNum = 321;BA.debugLine="PreprocessExif(Media, IIf(FromFile, File.OpenIn";
Debug.JustUpdateDeviceLine();
...
//C
this.state = 19;
 BA.debugLineNum = 324;BA.debugLine="Dim in As InputStream = IIf(FromFile, File.OpenI";
Debug.JustUpdateDeviceLine();
...
_in = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.streams.File.InputStreamWrapper"), ((_fromfile.<Boolean>get().booleanValue()) ? ((parent.__c.getField(false,"File").runMethod(false,"OpenInput",(Object)(_dir),(Object)(_filename)).getObject())) : ((_job.runClassMethod (b4a.DesaWisataSumpu.httpjob.class, "_getinputstream" /*RemoteObject*/ ).getObject()))));Debug.locals.put("in", _in);Debug.locals.put("in", _in);
 BA.debugLineNum = 325;BA.debugLine="Select MediaType";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//C
this.state = 24;
 BA.debugLineNum = 327;BA.debugLine="Media.Media = Bit.InputStreamToBytes(in)";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("PreprocessExif (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,587);
...
Debug.locals.put("In", _in);
 BA.debugLineNum = 587;BA.debugLine="Public Sub PreprocessExif (Media As SMMedia, In As";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 591;BA.debugLine="If Media.Meta.Mime <> \"image/jpeg\" Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("!",_media.getField(false,"Meta" /*RemoteObject*/ ).getField(true,"Mime" /*RemoteObject*/ ),BA.ObjectToString("image/jpeg"))) { 
 BA.debugLineNum = 592;BA.debugLine="Log(\"image/jpeg mime expected!\")";
Debug.JustUpdateDeviceLine();
simplemediamanager.__c.runVoidMethod ("LogImpl","97864325",RemoteObject.createImmutable("image/jpeg mime expected!"),0);
 BA.debugLineNum = 593;BA.debugLine="In.Close";
Debug.JustUpdateDeviceLine();
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 597;BA.debugLine="If B4ASdkVersion >= 24 Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("g",__ref.getField(true,"_b4asdkversion" /*RemoteObject*/ ),BA.numberCast(double.class, 24))) { 
 BA.debugLineNum = 598;BA.debugLine="Dim ExifInterface As JavaObject";
Debug.JustUpdateDeviceLine();
_exifinterface = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");Debug.locals.put("ExifInterface", _exifinterface);
 BA.debugLineNum = 599;BA.debugLine="ExifInterface.InitializeNewInstance(\"android.med";
Debug.JustUpdateDeviceLine();
_exifinterface.runVoidMethod ("InitializeNewInstance",(Object)(BA.ObjectToString("android.media.ExifInterface")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {(_in.getObject())})));
 BA.debugLineNum = 600;BA.debugLine="Dim orientation As Int = ExifInterface.RunMethod";
Debug.JustUpdateDeviceLine();
_orientation = BA.numberCast(int.class, _exifinterface.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("getAttribute")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {(RemoteObject.createImmutable("Orientation"))}))));Debug.locals.put("orientation", _orientation);Debug.locals.put("orientation", _orientation);
 BA.debugLineNum = 601;BA.debugLine="Media.Media = RotateBitmapBasedOnOrientation(Med";
Debug.JustUpdateDeviceLine();
_media.setField ("Media" /*RemoteObject*/ ,(__ref.runClassMethod (b4a.DesaWisataSumpu.simplemediamanager.class, "_rotatebitmapbasedonorientation" /*RemoteObject*/ ,RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper"), _media.getField(false,"Media" /*RemoteObject*/ )),(Object)(_orientation)).getObject()));
 ...
 BA.debugLineNum = 603;BA.debugLine="In.Close";
Debug.JustUpdateDeviceLine();
_in.runVoidMethod ("Close");
...
try {
		Debug.PushSubsStack("RegisterForMeta (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,145);
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","96291470",RemoteObject.createImmutable("Unexpected state:  media.MediaState = STATE_ERROR"),0);
 if (true) break;
...
//C
this.state = 27;
 BA.debugLineNum = 193;BA.debugLine="meta.MetaState = STATE_ERROR";
Debug.JustUpdateDeviceLine();
...
this.state = 28;
;
 BA.debugLineNum = 195;BA.debugLine="job.Release";
Debug.JustUpdateDeviceLine();
_job.runClassMethod (b4a.DesaWisataSumpu.httpjob.class, "_release" /*RemoteObject*/ );
 if (true) break;
...
this.state = 29;
;
 BA.debugLineNum = 198;BA.debugLine="MetaIsReady(meta)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.simplemediamanager.class, "_metaisready" /*RemoteObject*/ ,(Object)(_meta));
 if (true) break;
...
try {
		Debug.PushSubsStack("RotateBitmapBasedOnOrientation (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,625);
...
try {
		Debug.PushSubsStack("SetMedia (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,91);
...
try {
		Debug.PushSubsStack("SetMediaFromFile (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,124);
...
Debug.JustUpdateDeviceLine();
simplemediamanager.__c.runVoidMethod ("LogImpl","96160392",RemoteObject.createImmutable("Invalid mime!"),0);
...
try {
		Debug.PushSubsStack("SetMediaWithExtra (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,107);
...
try {
		Debug.PushSubsStack("SetMediaWithRequestSet (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,141);
...
try {
		Debug.PushSubsStack("TrimMediaCache (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,414);
if (RapidSub.canDelegate("trimmediacache")) { return __ref.runUserSub(false, "simplemediamanager","trimmediacache", __ref);}
 BA.debugLineNum = 414;BA.debugLine="Public Sub TrimMediaCache";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 415;BA.debugLine="LastTrimCache = 0";
Debug.JustUpdateDeviceLine();
__ref.setField ("_lasttrimcache" /*RemoteObject*/ ,BA.numberCast(long.class, 0));
 BA.debugLineNum = 416;BA.debugLine="TrimMediaCacheImpl";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.simplemediamanager.class, "_trimmediacacheimpl" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("TrimMediaCacheImpl (simplemediamanager) ","simplemediamanager",17,__ref.getField(false, "ba"),__ref,419);
...
RemoteObject _media = RemoteObject.declareNull("b4a.DesaWisataSumpu.simplemediamanager._smmedia");
 BA.debugLineNum = 419;BA.debugLine="Private Sub TrimMediaCacheImpl";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 420;BA.debugLine="If DateTime.Now > LastTrimCache + MinTimeBetweenT";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",simplemediamanager.__c.getField(false,"DateTime").runMethod(true,"getNow"),RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_lasttrimcache" /*RemoteObject*/ ),__ref.getField(true,"_mintimebetweentrims" /*RemoteObject*/ )}, "+",1, 2))) { 
 BA.debugLineNum = 421;BA.debugLine="Dim OnlyLookForDisconnectedTargets As Boolean =";
Debug.JustUpdateDeviceLine();
_onlylookfordisconnectedtargets = BA.ObjectToBoolean(RemoteObject.solveBoolean("<",__ref.getField(false,"_mediacache" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xorderedmap.class, "_getsize" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_maxmediacachesize" /*RemoteObject*/ ))));Debug.locals.put("OnlyLookForDisconnectedTargets", _onlylookfordisconnectedtargets);Debug.locals.put("OnlyLookForDisconnectedTargets", _onlylookfordisconnectedtargets);
 BA.debugLineNum = 422;BA.debugLine="LastTrimCache = DateTime.Now";
Debug.JustUpdateDeviceLine();
__ref.setField ("_lasttrimcache" /*RemoteObject*/ ,simplemediamanager.__c.getField(false,"DateTime").runMethod(true,"getNow"));
 BA.debugLineNum = 426;BA.debugLine="Dim i As Int = 0";
Debug.JustUpdateDeviceLine();
_i = BA.numberCast(int.class, 0);Debug.locals.put("i", _i);Debug.locals.put("i", _i);
 BA.debugLineNum = 427;BA.debugLine="Do While i < MediaCache.Size";
Debug.JustUpdateDeviceLine();
while (RemoteObject.solveBoolean("<",_i,BA.numberCast(double.class, __ref.getField(false,"_mediacache" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xorderedmap.class, "_getsize" /*RemoteObject*/ )))) {
 BA.debugLineNum = 428;BA.debugLine="Dim Media As SMMedia = MediaCache.Get(MediaCach";
Debug.JustUpdateDeviceLine();
_media = (__ref.getField(false,"_mediacache" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xorderedmap.class, "_get" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_mediacache" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xorderedmap.class, "_getkeys" /*RemoteObject*/ ).runMethod(false,"Get",(Object)(_i)))));Debug.locals.put("Media", _media);Debug.locals.put("Media", _media);
 BA.debugLineNum = 429;BA.debugLine="CancelDisconnectedTargets(Media)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.simplemediamanager.class, "_canceldisconnectedtargets" /*RemoteObject*/ ,(Object)(_media));
 BA.debugLineNum = 430;BA.debugLine="If OnlyLookForDisconnectedTargets = False And M";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_onlylookfordisconnectedtargets,simplemediamanager.__c.getField(true,"False")) && RemoteObject.solveBoolean(">",__ref.getField(false,"_mediacache" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSumpu.b4xorderedmap.class, "_getsize" /*RemoteObject*/ ),RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_maxmediacachesize" /*RemoteObject*/ ),RemoteObject.createImmutable(2)}, "/",0, 0)) && RemoteObject.solveBoolean("=",__ref.runClassMethod (b4a.DesaWisataSumpu.simplemediamanager.class, "_ismediastillrelevant" /*RemoteObject*/ ,(Object)(_media)),simplemediamanager.__c.getField(true,"False"))) { 
 BA.debugLineNum = 431;BA.debugLine="DeleteMedia(Media)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSumpu.simplemediamanager.class, "_deletemedia" /*RemoteObject*/ ,(Object)(_media));
 BA.debugLineNum = 432;BA.debugLine="i = i - 1";
Debug.JustUpdateDeviceLine();
_i = RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(1)}, "-",1, 1);Debug.locals.put("i", _i);
 };
 BA.debugLineNum = 434;BA.debugLine="i = i + 1";
Debug.JustUpdateDeviceLine();
_i = RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(1)}, "+",1, 1);Debug.locals.put("i", _i);
 }
;
