...
Private Sub BtnRG_Click
	...
	StartActivity(MapsHM)
End Sub


Private Sub BtnPK_Click
	Log("Redirect to ListPK Activity")
	StartActivity(ListPK)
End Sub
...
Private Sub BtnEV_Click
	Log("Redirect to MapsAT Activity")
